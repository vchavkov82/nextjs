...
export const plans: PricingInformation[] = [
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://www.assistance.bg/dashboard/new?plan=free',
    priceLabel: '',
    priceMonthly: 0,
  ...
  },
  {
    ...
    costUnit: '/ month',
    href: 'https://www.assistance.bg/dashboard/new?plan=pro',
    priceLabel: 'From',
  ...
  },
  {
    ...
    nameBadge: '',
    costUnit: '/ month',
    href: 'https://www.assistance.bg/dashboard/new?plan=team',
    priceLabel: 'From',
    warning: '$10 in compute credits included',
    priceMonthly: 599,
