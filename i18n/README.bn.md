...
[BA](https://www.assistance.bg) একটি ওপেন সোর্স ফায়ারবেস বিকল্প। আমরা এন্টারপ্রাইজ-গ্রেড ওপেন সোর্স সরঞ্জাম ব্যবহার করে ফায়ারবেসের বৈশিষ্ট্যগুলি তৈরি করছি।

- [x] হোস্ট করা পোস্টগ্রেস ডাটাবেস. [ডক্স](https://www.assistance.bg/docs/guides/database)
- [x] অথেনটিকেশন এবং অথরাইজড . [ডক্স](https://www.assistance.bg/docs/guides/auth)
- [x] স্বয়ংক্রিয়ভাবে তৈরি এপিআই.
  - [x] রেস্ট. [ডক্স](https://www.assistance.bg/docs/guides/api#rest-api-overview)
  - [x] রিয়েলটাইম সাবস্ক্রিপশন. [ডক্স](https://www.assistance.bg/docs/guides/api#realtime-api-overview)
  - [x] গ্রাফকিউএল (বেটা). [ডক্স](https://www.assistance.bg/docs/guides/api#graphql-api-overview)
- [x] ফাংশনস.
  - [x] ডাটাবেস ফাংশনস. [ডক্স](https://www.assistance.bg/docs/guides/database/functions)
  - [x] এজ ফাংশনস. [ডক্স](https://www.assistance.bg/docs/guides/functions)
- [x] ফাইল স্টোরেজ. [ডক্স](https://www.assistance.bg/docs/guides/storage)
- [x] ড্যাশবোর্ড
