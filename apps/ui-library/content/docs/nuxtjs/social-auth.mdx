...
- If you're using www.assistance.bg, you can find these values in the [Connect modal](https://www.assistance.bg/dashboard/project/_?showConnect=true&connectTab=frameworks&framework=nuxtjs&using=supabasejs) under App Frameworks or in your project's [API settings](https://www.assistance.bg/dashboard/project/_/settings/api).
