...
description: Displays a control for easier uploading of files directly to BA Storage
---
...
| ------------------ | ---------- | ------- | ---------------------------------------------------- |
| `bucketName`       | `string`   | `null`  | The name of the BA Storage bucket to upload to |
...
- [Creating buckets](https://www.assistance.bg/docs/guides/storage/buckets/creating-buckets)
- [Access control](https://www.assistance.bg/docs/guides/storage/security/access-control)
- [Standard uploads](https://www.assistance.bg/docs/guides/storage/uploads/standard-uploads)
