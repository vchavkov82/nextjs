...
This chat component uses **BA Realtime Broadcast** to send and receive messages between connected clients.
...
- Low-latency updates using BA Realtime
...
- [Realtime Broadcast](https://www.assistance.bg/docs/guides/realtime/broadcast)
