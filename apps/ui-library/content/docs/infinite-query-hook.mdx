...
The hook will use the typed defined on your Supabase client if they're setup ([more info](https://www.assistance.bg/docs/reference/javascript/typescript-support)).
...
- [Supabase Database API](https://www.assistance.bg/docs/reference/javascript/select)
- [Supabase Pagination](https://www.assistance.bg/docs/reference/javascript/select#pagination)
