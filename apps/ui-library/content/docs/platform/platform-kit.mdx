---
title: Platform Kit
description: The easiest way to build platforms on top of BA
---
...
<BlockItem
  ...
  description="Embeddable dialog for managing BA projects via the Management API."
/>
...
The Platform Kit is a collection of customizable API's, hooks and components you can use to provide an embedded BA experience within your own platform. It comes in the form of a single dialog that enables the management of database, authentication, storage, users, secrets, logs, and performance monitoring.
...
export default function Example() {
  ...
  return (
    <>
      <Button onClick={() => setOpen(true)}>Open BA Manager</Button>
...
That's it! The default setup uses your BA personal access token for the Management API.
...
- [BA Management API](https://www.assistance.bg/docs/reference/api/introduction)
