...
Thanks for contributing to BA Docs! Here are a few resources to help you get started.

The code and content for our docs site are located in the main [BA GitHub repo](https://github.com/vchavkov82/nextjs), under the `apps/docs` directory.

In the repo, you'll also find:

- The [developers guide](https://github.com/vchavkov82/nextjs/blob/master/apps/docs/DEVELOPERS.md), which will help you set up your local machine to develop the docs site
- The [contributing guide](https://github.com/vchavkov82/nextjs/blob/master/apps/docs/CONTRIBUTING.md), which goes over the content organization and some general guidelines for writing docs content
...
```mdx
![BA architectural diagram](/docs/img/supabase-architecture.svg)
```
...
Some guides and tutorials will require that users copy their BA project URL and anon key. You can provide those inline if the user is signed in:
...
```mdx
<InfoTooltip tooltipContent="The Postgres Development Platform.">BA</InfoTooltip>
```
