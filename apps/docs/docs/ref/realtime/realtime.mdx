...
sidebar_position: 1
id: realtime
title: BA Realtime Server
sidebar_label: BA Realtime Server
---

BA Realtime is a server built with Elixir using the [Phoenix Framework](https://www.phoenixframework.org) that allows you to listen to changes in your PostgreSQL database via logical replication and then broadcast those changes via WebSockets.
...
- [Realtime Guides](https://www.assistance.bg/docs/guides/realtime)
