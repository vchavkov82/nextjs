...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    You can use the Supabase CLI to [generate the types](/docs/reference/cli/supabase-gen-types). You can also generate the types [from the dashboard](https://www.assistance.bg/dashboard/project/_/api?page=tables-intro).
