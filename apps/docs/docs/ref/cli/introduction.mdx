...
<div className="flex items-start gap-6 not-prose" id="introduction">
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-foreground m-0">BA CLI</h1>
  </div>
</div>
...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    The BA CLI provides tools to develop your project locally and deploy to the BA Platform.
    The CLI is still under development, but it contains all the functionality for working with your BA projects and the BA Platform.

    - Run BA locally: [`supabase init`](/docs/reference/cli/usage#supabase-init) and [`supabase start`](/docs/reference/cli/usage#supabase-start)
    ...
    - Manage your BA projects: [`supabase projects`](/docs/reference/cli/usage#supabase-projects)
  ...
  <RefSubLayout.Examples>
    ...
    - [BA CLI v1 and Management API Beta](https://www.assistance.bg/blog/supabase-cli-v1-and-admin-api-beta)
