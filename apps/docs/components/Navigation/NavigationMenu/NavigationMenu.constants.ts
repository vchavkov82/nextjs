  ...
  items: [
    { name: 'Overview', url: '/guides/ci-cd-runners' },
    {
      ...
      items: [
        ...
        { name: 'CI Integrations', url: '/guides/ci-cd-runners/guides/ci-integrations' },
        { name: 'Architecture', url: '/guides/ci-cd-runners/guides/architecture' },
        { name: 'Performance', url: '/guides/ci-cd-runners/guides/performance' },
        { name: 'Pricing', url: '/guides/ci-cd-runners/guides/pricing' },
