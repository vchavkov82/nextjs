---
title = "Transferring from cloud to self-host in BA"
...
You can also find some useful information about self-hosting here: https://www.assistance.bg/docs/guides/self-hosting.
