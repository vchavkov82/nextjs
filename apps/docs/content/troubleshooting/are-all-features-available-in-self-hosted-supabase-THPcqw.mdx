---
title = "Are all features available in self-hosted BA?"
...
[BA Features](/docs/guides/getting-started/features#generally-available)

### Self-hosting documentation

For detailed steps and guidance on how to set up and manage your self-hosted BA instance, follow the documentation provided:
