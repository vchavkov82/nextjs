...
More on this in our doc here: [**https://www.assistance.bg/docs/guides/platform/database-size#disk-size**](/docs/guides/platform/database-size#disk-size).
