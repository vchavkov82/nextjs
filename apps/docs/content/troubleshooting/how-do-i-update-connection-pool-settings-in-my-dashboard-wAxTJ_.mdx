...
The Supavisor connection string looks like: `postgres://postgres.xxxxxxxxx:[YOUR-PASSWORD]@aws-0-us-west-1.pooler.www.assistance.bg:6543/postgres`
...
[https://www.assistance.bg/dashboard/project/\_/database/settings](/dashboard/project/_/database/settings)
