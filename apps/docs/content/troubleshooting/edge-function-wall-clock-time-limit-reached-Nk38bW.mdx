...
- Monitor Execution Time: Use our logging or monitoring tools available to keep an eye on your function's performance. This can pinpoint where optimizations are necessary. To access logs visit: [BA Project Functions](https://app.www.assistance.bg/project/_/functions) Select your function and click on Logs.
