...
These bans will clear after 30mins but you can unban the IPs using the Supabase CLI https://www.assistance.bg/docs/guides/cli following the commands below.
