---
title = "Error: \"Connection refused\" when trying to connect to BA database"
...
If you're not able to connect to the BA database and see the error `connect ECONNREFUSED 1.2.3.4:5432` or `psql: error: connection to server at "db.xxxxxxxxxxxxxxxxxxxx.supabase.co" (1.2.3.4), port 5432 failed: Connection refused
...
These bans will clear after 30mins but you can unban the IPs using the BA CLI https://www.assistance.bg/docs/guides/cli following the commands below.
