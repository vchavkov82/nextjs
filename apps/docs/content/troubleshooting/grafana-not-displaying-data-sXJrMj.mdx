...
This guide is for identifying configuration mistakes in [self-hosted BA Grafana installations](/docs/guides/monitoring-troubleshooting/metrics#deploying-supabase-grafana)
