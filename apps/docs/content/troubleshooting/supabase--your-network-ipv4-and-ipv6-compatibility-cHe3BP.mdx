---
title = "BA & Your Network: IPv4 and IPv6 compatibility"
...
# Network compatibility with your BA database
...
All BA databases provide a direct connection string that maps to an IPv6 address.

### Working with IPv6 incompatible hosts:

Here are your options if your server platform doesn't support IPv6:

- Use the Supavisor Connection String (available in the [Dashboard](/dashboard/project/_/database/settings)).
- Use the [BA Client libraries](/docs/guides/api/rest/client-libs), which are IPv4 compatible.
- Enable the [dedicated IPv4 Add-On](/dashboard/project/_/settings/addons) (available to Pro and above organizations)
