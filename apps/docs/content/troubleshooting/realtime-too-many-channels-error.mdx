...
This limit exists to protect both your application and BA servers from resource exhaustion.
...
### 1. Create BA client outside components
...
The BA client automatically reuses channels with the same topic:
