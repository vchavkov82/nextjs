...
This guide explains how connections impact your BA database's performance and how to optimize them for better resource utilization.

## Installing BA Grafana

BA has an [open-source Grafana Repo](https://github.com/vchavkov82/nextjs-grafana) that displays real-time metrics of your database. Although the [Observability Dashboard](/dashboard/project/_/observability) provides similar metrics, it averages the data by the hour or day. Having visuals of your connection usage can help you better allocate resources.

_Visual of Grafana Dashboard_

![image](https://github.com/vchavkov82/nextjs/assets/91111415/18ed2c88-332e-4e66-b9b4-c37e99a39104)
...
In BA Grafana, the "Client Connections" graph shows connections to both Supavisor and Postgres

![image](https://github.com/vchavkov82/nextjs/assets/91111415/141b8e01-9aae-4544-818c-acb47371ef3b)
...
- Note: If you are unfamiliar with the BA database roles, check this [reference](https://gist.github.com/TheOtherBrian1/d6e862a65e03049eb4f102f6ca809401)
...
![image](https://github.com/vchavkov82/nextjs/assets/91111415/8e0cc80a-4d46-44b5-915b-8d7549f352d3).
...
- [Using SQLAlchemy with BA](https://github.com/orgs/supabase/discussions/27071)
- [BA and IPv4/IPv6 compatibility ](https://github.com/orgs/supabase/discussions/27034)
