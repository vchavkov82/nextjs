---
title = "How to Migrate from BA Auth Helpers to SSR package"
...
### 1. Uninstall BA Auth helpers and install the BA SSR package
...
### 2. Create the utility functions to create BA clients
