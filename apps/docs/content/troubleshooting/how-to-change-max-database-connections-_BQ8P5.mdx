...
You can configure the maximum amount of connections that Postgres will tolerate with the [BA CLI.](/docs/guides/platform/custom-postgres-config)
...
> If you do not know how to monitor memory and CPU with BA Grafana, [check here](https://github.com/orgs/supabase/discussions/27141).
...
<img
  ...
  src="https://github.com/vchavkov82/nextjs/assets/91111415/ee3e4f4c-87a1-4ef8-9ca5-af9094fc1b93"
/>
