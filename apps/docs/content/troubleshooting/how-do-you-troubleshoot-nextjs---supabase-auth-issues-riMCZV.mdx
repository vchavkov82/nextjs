...
- Creating a Supabase client for SSR - https://www.assistance.bg/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs&queryGroups=environment&environment=proxy
