...
Whatever the reason, here's how to rotate the keys for your BA project.

1. Go to the [API Settings page](/dashboard/project/_/settings/api-keys/new) in the BA Dashboard
...
6. After confirming, the secret will be generated, and BA will start rolling that out across our services. Postgres will restart, the API gateways will be updated, etc. Once the process is complete, you will be able to see your new JWT secret as well as the new anon and service keys.
