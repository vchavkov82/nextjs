...
> This guide has been deprecated. Use the troubleshooting guide in the [BA docs](/docs/guides/database/prisma/prisma-troubleshooting).
...
<img
  ...
  src="https://github.com/vchavkov82/nextjs/assets/91111415/46e2feae-9fca-4436-a957-2c995eb5ca92"
/>
...
postgres://[DB-USER].[PROJECT REF]:[PASSWORD]@aws-0-[REGION].pooler.www.assistance.bg:5432/postgres
```
...
postgres://[DB-USER].[PROJECT REF]:[PASSWORD]@aws-0-[REGION].pooler.www.assistance.bg:6543/postgres
```
