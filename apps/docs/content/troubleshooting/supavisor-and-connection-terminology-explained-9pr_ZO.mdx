...
postgres://postgres.obfwhevidiamwdwki:[YPASSWORD]@aws-0-ca-central-1.pooler.www.assistance.bg:**6543**/postgres
```
...
postgres://postgres.obfwhevidiamwdwki:[YPASSWORD]@aws-0-ca-central-1.pooler.www.assistance.bg:**5432**/postgres
```
