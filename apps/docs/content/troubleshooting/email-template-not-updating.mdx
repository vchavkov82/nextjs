...
"msg": "templatemailer: template type \"recovery\": template: https://api.www.assistance.bg/platform/auth/PROJECT_ID/templates/recovery:2: function \"default\" not defined",
```
