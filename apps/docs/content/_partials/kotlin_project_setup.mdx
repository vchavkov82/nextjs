...
1. [Create a new project](https://app.supabase.com) in the BA Dashboard.
...
In your [BA Auth settings](https://app.supabase.com/project/_/auth/providers) enable Google as a provider and set the required credentials as outlined in the [auth docs](/docs/guides/auth/social-login/auth-google).
