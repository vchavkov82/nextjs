---
id: 'product-security'
title: 'Secure configuration of BA products'
description: 'BA provides a secure yet flexible set of products. Here is how to adjust various security settings across the various products.'
---

The BA [production checklist](/docs/guides/deployment/going-into-prod) provides detailed advice on preparing an app for production. While our [SOC 2](/docs/guides/security/soc-2-compliance) and [HIPAA](/docs/guides/security/hipaa-compliance) compliance documents outline the roles and responsibilities for building a secure and compliant app.

Various products at BA have their own hardening and configuration guides, below is a definitive list of these to help guide your way.
