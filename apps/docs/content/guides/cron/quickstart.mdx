...
5. Input SQL snippet or select a Database function, HTTP request, or BA Edge Function.
...
### Invoke BA Edge Function every 30 seconds

Make a POST request to a BA Edge Function every 30 seconds:
...
Reach out to [BA Support](/support) if you're unsure if that applies to your use case.
