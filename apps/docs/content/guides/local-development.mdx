...
subtitle: Learn how to develop locally and use the BA CLI
---

Develop locally while running the BA stack on your machine.
...
2.  In your repo, initialize the BA project:
...
4.  View your local BA instance at [http://localhost:54323](http://localhost:54323).
...
Local development with BA allows you to work on your projects in a self-contained environment on your local machine. Working locally has several advantages:
...
To get started with local development, you'll need to install the [BA CLI](#cli) and Docker. The BA CLI allows you to start and manage your local BA stack, while Docker is used to run the necessary services.

Once set up, you can initialize a new BA project, start the local stack, and begin developing your application using local BA services. This includes access to a local Postgres database, Auth, Storage, and other BA features.

## CLI

The BA CLI is a powerful tool that enables developers to manage their BA projects directly from the terminal. It provides a suite of commands for various tasks, including:

- Setting up and managing local development environments
- Generating TypeScript types for your database schema
- Handling database migrations
- Managing environment variables and secrets
- Deploying your project to the BA platform
