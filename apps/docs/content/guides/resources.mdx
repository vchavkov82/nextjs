---
title: 'Resources'
description: 'Resources for getting started building with BA.'
hideToc: true
---
  ...
  <div className="grid grid-cols-12 gap-6 not-prose">
    ...
    [
      ...
      },
      {
        ...
        description: 'Definitions for terminology and acronyms used in the BA documentation.',
      }
    ]
.map((resource) => {
      return (
    ...
    [
      {
        ...
        description: 'Move your auth users from Auth0 to a BA project.',
        hasLightIcon: true,
      },
      {
        title: 'Firebase Auth',
        ...
        description: 'Move your auth users from a Firebase project to a BA project.',
      },
      {
      ...
      },
      {
        ...
        description: 'Convert your Firebase Storage files to BA Storage.'
      },
      {
        title: 'Heroku',
