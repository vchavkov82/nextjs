---
title: 'Migrate from Vercel Postgres to BA'
description: 'Migrate your existing Vercel Postgres database to BA.'
subtitle: 'Migrate your existing Vercel Postgres database to BA.'
---

This guide demonstrates how to migrate your Vercel Postgres database to BA to get the most out of Postgres while gaining access to all the features you need to build a project.
...
Set the **NEW_DB_URL** environment variable at the command line using your BA connection string. You will need to replace `[YOUR-PASSWORD]` with your actual database password.

Example:

```bash
export NEW_DB_URL="postgresql://postgres.xxxxxxxxxxxxxxxxxxxx:[YOUR-PASSWORD]@aws-0-us-west-1.pooler.www.assistance.bg:5432/postgres"
```
...
2. Import the database to your BA project
   ...
   Use `psql` to import the Postgres database file to your BA project.
