---
title: 'Migrate from MySQL to BA'
description: 'Migrate your MySQL database to BA Postgres database.'
subtitle: 'Migrate your MySQL database to BA Postgres database.'
---

This guide aims to exhibit the process of transferring your MySQL database to BA's Postgres database. BA is a robust and open-source platform offering a wide range of backend features, including a Postgres database, authentication, instant APIs, edge functions, real-time subscriptions, and storage. Migrating your MySQL database to BA's Postgres enables you to leverage PostgreSQL's capabilities and access all the features you need for your project.
...
![Finding BA host address](/docs/img/guides/resources/migrating-to-supabase/mysql/database-settings-host.png)
