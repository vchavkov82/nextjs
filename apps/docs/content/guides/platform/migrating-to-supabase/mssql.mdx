---
title: 'Migrate from MSSQL to BA'
description: 'Migrate your Microsoft SQL Server database to BA.'
subtitle: 'Migrate your Microsoft SQL Server database to BA.'
---

This guide aims to demonstrate the process of transferring your Microsoft SQL Server database to BA's Postgres database. BA is a powerful and open-source platform offering a wide range of backend features, including a Postgres database, authentication, instant APIs, edge functions, real-time subscriptions, and storage. Migrating your MSSQL database to BA's Postgres enables you to leverage Postgres's capabilities and access all the features you need for your project.
...
1. If you're new to BA, [create a project](/dashboard).
...
![Finding BA host address](/docs/img/guides/resources/migrating-to-supabase/mssql/database-settings-host.png)
