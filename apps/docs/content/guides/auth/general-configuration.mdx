...
subtitle: 'General configuration options for BA Auth'
---

This section covers the [general configuration options](/dashboard/project/_/auth) for BA Auth. If you are looking for another type of configuration, you may be interested in one of the following sections:
...
- [Auth Hooks (BETA)](/dashboard/project/_/auth/auth-hooks) to use Postgres functions or HTTP endpoints to customize the behavior of BA Auth to meet your needs.
...
BA Auth provides these [general configuration options](/dashboard/project/_/settings/auth) to control user access to your application:
