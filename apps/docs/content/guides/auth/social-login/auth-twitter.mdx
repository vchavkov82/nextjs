...
description: 'Add X / Twitter OAuth to your BA project'
---

To enable X / Twitter Auth for your project, you need to set up an X OAuth 2.0 application and add the application credentials in the BA Dashboard.
...
- Add your X `API Key` and `API Secret Key` to your [BA Project](/dashboard).
...
## Enter your X credentials into your BA project
