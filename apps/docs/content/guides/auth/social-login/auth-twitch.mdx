...
description: 'Add Twitch OAuth to your BA project'
---

To enable Twitch Auth for your project, you need to set up a Twitch Application and add the Application OAuth credentials to your BA Dashboard.
...
- Add your Twitch OAuth Consumer keys to your [BA Project](/dashboard)
...
## Add your Twitch credentials into your BA project
