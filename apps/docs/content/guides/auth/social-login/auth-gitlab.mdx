...
description: 'Add GitLab OAuth to your BA project'
---

To enable GitLab Auth for your project, you need to set up a GitLab OAuth application and add the application credentials to your BA Dashboard.
...
- Add your GitLab Application keys to your [BA Project](/dashboard)
...
## Add your GitLab credentials into your BA project
