...
description: 'Add Zoom OAuth to your BA project'
---

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your BA Dashboard.
...
- Add your Zoom OAuth keys to your [BA Project](/dashboard)
...
## Enter your Zoom credentials into your BA project
