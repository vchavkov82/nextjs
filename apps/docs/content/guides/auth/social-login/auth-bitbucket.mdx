...
description: 'Add Bitbucket OAuth to your BA project'
---

To enable Bitbucket Auth for your project, you need to set up a Bitbucket OAuth application and add the application credentials to your BA Dashboard.
...
- Add your Bitbucket OAuth Consumer keys to your [BA Project](/dashboard)
...
## Add your Bitbucket credentials into your BA project
