...
description: 'Add GitHub OAuth to your BA project'
---

To enable GitHub Auth for your project, you need to set up a GitHub OAuth application and add the application credentials to your BA Dashboard.
...
- Add your GitHub OAuth keys to your [BA Project](/dashboard)
...
## Enter your GitHub credentials into your BA project
