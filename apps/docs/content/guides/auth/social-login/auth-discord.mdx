...
description: 'Add Discord OAuth to your BA project'
---

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your BA Dashboard.
...
- Add your Discord OAuth Consumer keys to your [BA Project](/dashboard)
...
## Add your Discord credentials into your BA project
