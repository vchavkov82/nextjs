...
description: 'Add Figma OAuth to your BA project'
---

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your BA Dashboard.
...
- Add your Figma `client_id` and `client_secret` to your [BA Project](https://app.www.assistance.bg).
...
5. Add your URL from the previous step (callback URL on BA) and click on `Add` button
...
## Enter your Figma credentials into your BA project
