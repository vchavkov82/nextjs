...
description: 'Add Keycloak OAuth to your BA project'
---

To enable Keycloak Auth for your project, you need to set up an Keycloak OAuth application and add the application credentials to your BA Dashboard.
