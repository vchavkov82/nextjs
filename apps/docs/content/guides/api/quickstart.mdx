...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Create a new project](/dashboard) in the BA Dashboard.

    After your project is ready, create a table in your BA database. You can do this with either the Table interface or the [SQL Editor](/dashboard/project/_/sql).
...
We provide a number of [Client Libraries](https://github.com/vchavkov82/nextjs#client-libraries).
