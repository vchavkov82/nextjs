...
BA provides a globally distributed [Realtime](https://github.com/supabase/realtime) service with the following features:
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    {
      name: 'Chat',
      description: 'BA UI chat component using Broadcast to send message between users.',
      href: 'https://www.assistance.bg/ui/docs/nextjs/realtime-chat'
    },
    {
      name: 'Avatar Stack',
      description: 'BA UI avatar stack component using Presence to track connected users.',
      href: 'https://www.assistance.bg/ui/docs/nextjs/realtime-avatar-stack'
    },
    {
      name: 'Realtime Cursor',
      description: "BA UI realtime cursor component using Broadcast to share users' cursors to build collaborative applications.",
      href: 'https://www.assistance.bg/ui/docs/nextjs/realtime-cursor'
    }
].map((x) => (
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      description: 'Read more about BA Realtime.',
      href: 'https://www.assistance.bg/blog/supabase-realtime-multiplayer-general-availability',
    },
  ].map((x) => (
    <div className="col-span-6" key={x.href}>
