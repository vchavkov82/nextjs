...
| **Reserved**    | Administrative connections for BA services |
| **Auth**        | Connections from BA Auth service           |
| **Storage**     | Connections from BA Storage service        |
...
| Service distribution monitoring | Monitor connection usage across different BA services |
...
The Auth report focuses on user authentication patterns and behaviors within your BA project.
...
The Storage report provides visibility into how your BA Storage is being utilized, including request patterns, performance characteristics, and caching effectiveness.
...
The Realtime report tracks WebSocket connections, channel activity, and real-time event patterns in your BA project.
...
The Edge Functions report provides insights into serverless function performance, execution patterns, and regional distribution across BA's global edge network.
...
The API Gateway report analyzes traffic patterns and performance characteristics of requests flowing through your BA project's API layer.
