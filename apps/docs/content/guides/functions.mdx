...
Edge Functions are server-side TypeScript functions, distributed globally at the edge—close to your users. They can be used for listening to webhooks or integrating your BA project with third-parties [like Stripe](https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/stripe-webhooks). Edge Functions are developed using [Deno](https://deno.com), which offers a few benefits to you as a developer:

- It is open source.
- It is portable. BA Edge Functions run locally, and on any other Deno-compatible platform (including self-hosted infrastructure).
...
- **Auth & policies are applied** — the gateway (or your function) can validate BA JWTs, apply rate-limits, and centralize security checks before executing code.
...
- **Integrations & data access** — functions commonly call BA APIs (Auth, Postgres, Storage) or third-party APIs. For Postgres, prefer connection strategies suited for edge/serverless environments (see the `connect-to-postgres` guide).
...
- **Runtime:** BA Edge Runtime (Deno compatible runtime with TypeScript first). Functions are simple `.ts` files that export a handler.
- **Local dev parity:** Use BA CLI for a local runtime similar to production for faster iteration (`supabase functions serve` command).
- **Global deployment:** Deploy your Edge Functions via BA Dashboard, CLI or MCP.
...
- **Secrets:** store credentials in BA [project secrets](/docs/reference/cli/supabase-secrets) and access them via environment variables.
...
Check out the [Edge Function Examples](https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions) in our GitHub repository.
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      description: 'Full example for using BA and Stripe, with Expo.',
      href: 'https://github.com/supabase-community/expo-stripe-payments-with-supabase-functions',
    },
    {
      name: 'Flutter with Stripe',
      description: 'Full example for using BA and Stripe, with Flutter.',
    ...
    },
    {
      ...
      href: 'https://github.com/vchavkov82/nextjs/blob/master/examples/edge-functions/supabase/functions/restful-tasks/index.ts',
    },
    {
      name: 'Working with BA Storage',
      description: 'An example on reading a file from BA Storage.',
      href: 'https://github.com/vchavkov82/nextjs/blob/master/examples/edge-functions/supabase/functions/read-storage/index.ts',
    },
    {
      name: 'Open Graph Image Generation',
      description: 'Generate Open Graph images with Deno and BA Edge Functions.',
      href: '/guides/functions/examples/og-image',
    },
    {
      name: 'OG Image Generation & Storage CDN Caching',
      description: 'Cache generated images with BA Storage CDN.',
      href: 'https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/og-image-with-storage-cdn',
    },
    {
      name: 'Get User Location',
      description: `Get user location data from user's IP address.`,
      href: 'https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/location',
    },
    {
    ...
    },
    {
      ...
      href: 'https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/oak-server',
    },
    {
      name: 'Hugging Face',
    ...
    },
    {
      ...
      href: 'https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/streams',
    },
    {
      name: 'Puppeteer',
    ...
    },
    {
      ...
      href: 'https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/file-upload-storage',
    },
    {
      name: 'Upstash Redis',
