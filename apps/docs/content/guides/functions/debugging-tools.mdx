...
Since [v1.171.0](https://github.com/supabase/cli/releases/tag/v1.171.0) the BA CLI supports debugging Edge Functions via the v8 inspector protocol, allowing for debugging via [Chrome DevTools](https://developer.chrome.com/docs/devtools/) and other Chromium-based browsers.
