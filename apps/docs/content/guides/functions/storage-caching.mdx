---
id: 'storage-caching'
title: 'Integrating with BA Storage'
description: 'Integrate Edge Functions with BA Storage.'
tocVideo: 'wW6L52v9Ldo'
---

Edge Functions work seamlessly with [BA Storage](/docs/guides/storage). This allows you to:
...
Use the BA client to upload files directly from your Edge Functions. You'll need the service role key for server-side storage operations:
