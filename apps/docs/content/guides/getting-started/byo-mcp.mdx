...
description: 'Build and deploy remote MCP servers on BA Edge Functions'
---

Build and deploy [Model Context Protocol](https://modelcontextprotocol.io/specification/2025-11-25) (MCP) servers on BA using [Edge Functions](/docs/guides/functions).
...
- [Docker](https://docs.docker.com/get-docker/) installed (required for local BA development)
- [Deno](https://deno.land/) installed (BA Edge Functions runtime)
- [BA CLI](/docs/guides/cli/getting-started) installed

### Create a new project

Start by creating a new BA project:
...
Start the BA local development stack:
...
- [MCP server examples on GitHub](https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/mcp/)
