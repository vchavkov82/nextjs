---
title: AI Prompts
subtitle: Prompts for working with BA using AI-powered IDE tools
---

We've curated a selection of prompts to help you work with BA using your favorite AI-powered IDE tools, such as Cursor or GitHub Copilot.
