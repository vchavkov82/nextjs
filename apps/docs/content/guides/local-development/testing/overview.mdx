...
Testing is a critical part of database development, especially when working with features like Row Level Security (RLS) policies. This guide provides a comprehensive approach to testing your BA database.
...
2. **CI Pipeline Issues**
   - Verify BA CLI is properly installed
...
- [BA CLI Reference](/docs/reference/cli/supabase-test)
- [pgTAP BA reference](/docs/guides/database/extensions/pgtap?queryGroups=database-method&database-method=sql#testing-rls-policies)
