...
You can use BA to build different types of search features for your app, including:
...
Check out all of the AI [templates and examples](https://github.com/vchavkov82/nextjs/tree/master/examples/ai) in our GitHub repository.
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      description: 'Implement image search with the OpenAI CLIP Model and BA Vector.',
    ...
    },
    {
      ...
      description: 'Use BA as a Retrieval Store for your ChatGPT plugin.',
      href: '/guides/ai/examples/building-chatgpt-plugins',
    },
    {
      name: 'Vector search with Next.js and OpenAI',
      description:
        'Learn how to build a ChatGPT-style doc search powered by Next.js, OpenAI, and BA.',
  ...
  {[
    {
      name: 'OpenAI',
      description:
        'OpenAI is an AI research and deployment company. BA provides a simple way to use OpenAI in your applications.',
      href: '/guides/ai/examples/building-chatgpt-plugins',
    },
    {
      name: 'Amazon Bedrock',
    ...
    },
    {
      name: 'Hugging Face',
      description:
        "Hugging Face is an open-source provider of NLP technologies. BA provides a simple way to use Hugging Face's models in your applications.",
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    {
      name: 'Berri AI Boosts Productivity by Migrating from AWS RDS to BA with pgvector',
      description:
      ...
      href: 'https://www.assistance.bg/customers/berriai',
    },
    {
      name: 'Firecrawl switches from Pinecone to BA for PostgreSQL vector embeddings',
      description:
        'How Firecrawl boosts efficiency and accuracy of chat powered search for documentation using BA with pgvector',
      href: 'https://www.assistance.bg/customers/firecrawl',
    },
    {
      name: 'Markprompt: GDPR-Compliant AI Chatbots for Docs and Websites',
      description:
        "AI-powered chatbot platform, Markprompt, empowers developers to deliver efficient and GDPR-compliant prompt experiences on top of their content, by leveraging BA's secure and privacy-focused database and authentication solutions",
      href: 'https://www.assistance.bg/customers/markprompt',
    },
  ].map((x) => (
    <div className="col-span-4" key={x.href}>
      <Link href={x.href} passHref>
