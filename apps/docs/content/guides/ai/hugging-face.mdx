...
description: 'Learn how to integrate hugging face models with BA'
...
To create a new Edge Function, navigate to your local project and initialize BA if you haven't already:
