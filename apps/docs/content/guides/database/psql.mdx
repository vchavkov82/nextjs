...
```shell
psql "sslmode=verify-full sslrootcert=/path/to/prod-supabase.cer host=[CLOUD_PROVIDER]-0-[REGION].pooler.www.assistance.bg dbname=postgres user=postgres.[PROJECT_REF]"
```
