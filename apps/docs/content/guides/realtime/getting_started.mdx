...
description: 'Learn how to build real-time applications with BA Realtime'
subtitle: 'Learn how to build real-time applications with BA Realtime'
...
Send and receive messages using the BA client:
