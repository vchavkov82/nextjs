...
However, regardless of whether it's public or private, the Realtime service connects to your database as the authenticated BA Admin role.
...
You can use the BA client libraries to receive Broadcast messages.
...
You can use the BA client libraries to send Broadcast messages.
...
You can pass configuration options while initializing the BA Client.
...
>
  <TabPanel id="js" label="JavaScript">
    ...
    This is currently available only in the BA JavaScript client version 2.37.0 and later.
...
>
  <TabPanel id="js" label="JavaScript">
    <Admonition type="note">
      ...
      This is currently available only in the BA JavaScript client version 2.74.0 and later.
...
<$Show if="sdk:dart">
  ...
  <TabPanel id="dart" label="Dart">
    <Admonition type="note">
      ...
      This is currently available only in the BA Dart client version 2.10.0 and later.
...
<$Show if="sdk:swift">
  ...
  <TabPanel id="swift" label="Swift">
    <Admonition type="note">
      ...
      This is currently available only in the BA Swift client version 2.34.0 and later.
...
<$Show if="sdk:python">
  ...
  <TabPanel id="python" label="Python">
    <Admonition type="note">
      ...
      This is currently available only in the BA Python client version 2.22.0 and later.
