...
description: 'Architecture of the BA Realtime service'
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the BA Realtime cluster do this easily.
...
Thanks to the Realtime cluster, you (an amazing BA user) don't have to think about which regions your clients are connected to.
