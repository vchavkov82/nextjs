...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Create a new project](https://app.supabase.com) in the BA Dashboard.

    After your project is ready, create a table in your BA database. You can do this with either the Table interface or the [SQL Editor](https://app.supabase.com/project/_/sql).
