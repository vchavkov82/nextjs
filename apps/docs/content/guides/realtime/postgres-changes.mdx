...
subtitle: 'Listen to Postgres changes using BA Realtime.'
description: 'Listen to Postgres changes using BA Realtime.'
---
...
In this example we'll set up a database table, secure it with Row Level Security, and subscribe to all changes using the BA client libraries.

<StepHikeCompact>

  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a BA project with a 'todos' table">

    [Create a new project](https://app.www.assistance.bg) in the BA Dashboard.

    After your project is ready, create a table in your BA database. You can do this with either the Table interface or the [SQL Editor](https://app.www.assistance.bg/project/_/sql).
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Install the client">
      ...
      Install the BA JavaScript client.
...
You can use the BA client libraries to subscribe to database changes.
...
Your project JWT secret is found with your [Project API keys](https://app.www.assistance.bg/project/_/settings/api) in your dashboard.
...
To use your own JWT with Realtime make sure to set the token after instantiating the BA client and before connecting to a Channel.
