...
You can use the [Realtime Inspector](https://realtime.www.assistance.bg/inspector/new) to reproduce an error and share those connection details with BA support.
