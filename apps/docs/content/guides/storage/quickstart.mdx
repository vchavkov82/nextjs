...
This guide shows the basic functionality of BA Storage. Find a full [example application on GitHub](https://github.com/vchavkov82/nextjs/tree/master/examples/user-management/nextjs-user-management).
