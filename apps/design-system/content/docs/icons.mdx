---
title: Icons
description: Icons make actions and navigation across BA easier.
---
...
3. Consistent: Use the same icons for similar actions throughout BA. This makes the app easier to use.
...
Follow these steps to add a new custom icon to the BA icon library.
