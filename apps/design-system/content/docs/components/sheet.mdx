...
See [`LayoutSidebarProvider`](https://github.com/vchavkov82/nextjs/blob/master/apps/studio/components/layouts/ProjectLayout/LayoutSidebar/LayoutSidebarProvider.tsx) for more.
