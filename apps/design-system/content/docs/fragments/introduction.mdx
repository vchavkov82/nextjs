...
These components help maintain consistency across BA products by providing standardized implementations for common interface patterns like data visualization, dialogs, empty states, forms, layout, and navigation.
