...
const data = {
  ...
  heroSection: {
    ...
    subheader: [
      <>
        Supabase gives you everything Firebase can&apos;t: a real SQL database, row-level security,
        built-in auth, edge functions, and predictable pricing—all on an open-source foundation.
      </>,
      <>
        Whether you&apos;re building mobile apps, SaaS tools, or AI-native products, Supabase helps
    ...
    image: (
      <Image
        ...
        alt="Firebase to Supabase illustration"
        width={1000}
        height={1000}
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to Supabase from Firebase</span>
      </>
    ),
    subheading:
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'Supabase includes auth, storage, edge functions, realtime, and vector search—fully integrated and ready to use. Avoid stitching together multiple Firebase products or paying for separate services.',
      },
      {
        id: 'scalability',
        ...
        subheading:
          'Supabase runs on standard Postgres with full SQL support, ACID transactions, PITR, high availability, and native support for complex queries and joins. Ideal for apps that outgrow NoSQL constraints.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        ...
        subheading:
          'Supabase offers open-source tools for migrating Firebase Auth, Firestore data, and Cloud Storage. Move incrementally or all at once—no need to rewrite your entire app.',
      },
    ],
  },
  platform: {
    ...
    subheading:
      'Supabase includes everything you liked in Firebase, and all the things you wish Firebase had.',
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Firebase database to Supabase to{' '}
