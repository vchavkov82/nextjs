...
const data = {
  ...
  heroSection: {
    ...
    subheader: [
      <>
        BA gives you everything Firebase can&apos;t: a real SQL database, row-level security,
        built-in auth, edge functions, and predictable pricing—all on an open-source foundation.
      </>,
      <>
        Whether you&apos;re building mobile apps, SaaS tools, or AI-native products, BA helps
        you move fast without hitting Firebase&apos;s scaling and complexity ceilings.
      </>,
    ],
    ctas: [
      {
        label: 'Compare Firebase and BA',
    ...
    image: (
      <Image
        ...
        alt="Firebase to BA illustration"
        width={1000}
        height={1000}
  ...
  quote: {
    ...
    text: 'Migrating to BA meant that we could instantly fix our Auth problems and save money. Just being on BA alone gives us confidence we can deliver on whatever users need in the future.',
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to BA from Firebase</span>
      </>
    ),
    subheading:
    ...
    features: [
      {
        ...
        subheading:
          'BA helps you go from prototype to production with built-in auth, real-time data, and observability. No setup or backend boilerplate required.',
      },
      {
        id: 'platform',
        icon: CubeIcon,
        ...
        subheading:
          'BA includes auth, storage, edge functions, realtime, and vector search—fully integrated and ready to use. Avoid stitching together multiple Firebase products or paying for separate services.',
      },
      {
        id: 'scalability',
        ...
        subheading:
          'BA runs on standard Postgres with full SQL support, ACID transactions, PITR, high availability, and native support for complex queries and joins. Ideal for apps that outgrow NoSQL constraints.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        ...
        subheading:
          'BA offers open-source tools for migrating Firebase Auth, Firestore data, and Cloud Storage. Move incrementally or all at once—no need to rewrite your entire app.',
      },
    ],
  },
  platform: {
    ...
    title: (
      <>
        BA is an open-source Firebase alternative{' '}
        <span className="text-foreground">built for scale</span>
      </>
    ),
    subheading:
      'BA includes everything you liked in Firebase, and all the things you wish Firebase had.',
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  developerExperience: {
    ...
    title: (
      <>
        Developers can build <span className="text-foreground">faster</span> with BA
      </>
    ),
    ...
    features: [
      {
        ...
        subheading:
          'A single panel that persists across the BA Dashboard and maintains context across AI prompts.',
        image: (
      ...
      },
      {
        ...
        subheading:
          'Connect your favorite AI tools such as Cursor or Claude directly with BA.',
        image: (
          <Image
            draggable={false}
            src={{
      ...
      },
      {
        ...
        icon: 'M4.13477 12.8129C4.13477 14.1481 4.43245 15.4138 4.96506 16.5471M12.925 4.02271C11.5644 4.02271 10.276 4.33184 9.12614 4.88371M21.7152 12.8129C21.7152 11.4644 21.4115 10.1867 20.8688 9.0447M12.925 21.6032C14.2829 21.6032 15.5689 21.2952 16.717 20.7454M16.717 20.7454C17.2587 21.5257 18.1612 22.0366 19.1831 22.0366C20.84 22.0366 22.1831 20.6935 22.1831 19.0366C22.1831 17.3798 20.84 16.0366 19.1831 16.0366C17.5263 16.0366 16.1831 17.3798 16.1831 19.0366C16.1831 19.6716 16.3804 20.2605 16.717 20.7454ZM4.96506 16.5471C4.16552 17.086 3.63965 17.9999 3.63965 19.0366C3.63965 20.6935 4.98279 22.0366 6.63965 22.0366C8.2965 22.0366 9.63965 20.6935 9.63965 19.0366C9.63965 17.3798 8.2965 16.0366 6.63965 16.0366C6.01951 16.0366 5.44333 16.2248 4.96506 16.5471ZM9.12614 4.88371C8.58687 4.08666 7.67444 3.56274 6.63965 3.56274C4.98279 3.56274 3.63965 4.90589 3.63965 6.56274C3.63965 8.2196 4.98279 9.56274 6.63965 9.56274C8.2965 9.56274 9.63965 8.2196 9.63965 6.56274C9.63965 5.94069 9.45032 5.36285 9.12614 4.88371ZM20.8688 9.0447C21.6621 8.50486 22.1831 7.59464 22.1831 6.56274C22.1831 4.90589 20.84 3.56274 19.1831 3.56274C17.5263 3.56274 16.1831 4.90589 16.1831 6.56274C16.1831 8.2196 17.5263 9.56274 19.1831 9.56274C19.8081 9.56274 20.3884 9.37165 20.8688 9.0447Z',
        subheading:
          "Learn SQL when you're ready. In the meantime, BA generates automatic APIs to make coding a lot easier.",
        image: (
          <Image
            draggable={false}
            src={{
      ...
      },
      {
        ...
        subheading:
          'Connect BA to Redshift, BigQuery, MySQL, and external APIs for seamless integrations.',
        image: (
          <Image
            draggable={false}
            src={{
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Firebase database to BA to{' '}
