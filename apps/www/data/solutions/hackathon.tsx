...
const data: () => {
  ...
  return {
    ...
    heroSection: {
      ...
      subheader: [
        <>
          In just a few hours, you can turn your idea into a working app. BA gives you
    ...
    quote: {
      ...
      text: 'We used BA at the hackathon because it let us go from idea to MVP in under two days. Then it took only a couple of months to turn that janky MVP into a production-ready application.',
    ...
    why: {
      ...
      heading: (
        <>
          <span className="text-foreground">Win</span> with BA
        </>
      ),
      subheading:
        'BA is the Postgres developer platform and Firebase alternative that developers everywhere love and trust. Build an instant backend for your application using everything you need to ship a winning app in seconds. Integrate with your favorite AI Builder tools and write code even faster.',
      features: [
        {
          id: 'easy-to-use',
          icon: Timer,
          ...
          subheading:
            'BA spins up everything you need instantly so you can get to the fun part: building a winning app. Enjoy a fully managed Postgres database with REST and GraphQL APIs out of the box. Connect using your favorite frontend or server-side framework.',
        },
        {
        ...
        },
        {
          ...
          subheading:
            'BA is just Postgres, so it&apos;s easy to scale your Hackathon project into a real product. Connect to your favorite AI tools and use built-in Vectors to store embeddings in Postgres. Use Foreign Data Wrappers to connect to Google Sheets, MySQL, BigQuery, and more.',
        },
      ],
    },
    platform: {
