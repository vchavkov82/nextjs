...
const data: () => {
  ...
  return {
    ...
    heroSection: {
      ...
      subheader: [
        <>
          BA is the Postgres development platform that includes a developer experience
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">developers</span> choose BA
        </>
      ),
      subheading:
        'BA helps you build and get to market faster and more cost-effectively using a composable platform of application services built on Postgres. BA scales as your business grows.',
      features: [
        {
          id: 'easy-to-use',
          icon: Timer,
        ...
        },
        {
          ...
          subheading:
            'Built on Postgres, BA provides enterprise-grade performance, high availability, and the flexibility to grow without vendor lock-in.',
        },
      ],
    },
    platform: {
