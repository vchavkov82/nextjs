...
const data = {
  metadata: {
    metaTitle: 'Switch from Neon to BA',
    metaDescription:
      'The complete Postgres development platform Neon users prefer. BA is a composable stack for modern applications: Postgres Database, built-in Auth, Real-time sync, Edge Functions, Storage, and a powerful developer experience.',
  },
  heroSection: {
    id: 'hero',
    title: 'Moving from Neon to BA',
    ...
    h1: 'Neon users switch to BA for a complete Postgres experience',
    subheader: [
      <>
        BA is a composable stack for modern applications: Postgres Database, built-in Auth,
        Real-time sync, Edge Functions, Storage, and a powerful developer experience.
      </>,
      <>
        BA is the preferred foundation for high-performance, high-scale SaaS, AI-native apps,
  ...
  quote: {
    ...
    text: 'We wanted a backend that could accelerate our development while maintaining security and scalability. BA stood out due to its automation, integrations, and ecosystem.',
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to BA from Neon</span>
      </>
    ),
    subheading:
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'BA runs on standard Postgres with full SQL, ACID guarantees, PITR, and high availability. Designed for reliable, stateful agent workloads.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        heading: 'Migrate from Neon with ease',
        subheading: 'BA is Postgres. Moving from Neon is a breeze.',
      },
    ],
  },
  platform: {
    ...
    title: (
      <>
        BA is the Postgres platform <span className="text-foreground">you control</span>
      </>
    ),
    subheading: "BA includes everything you've come to expect from Neon, and so much more.",
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Neon database to BA to{' '}
