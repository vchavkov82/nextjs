...
const Examples: Example[] = [
  {
    ...
    description:
      'The all-in-one subscription starter kit for high-performance SaaS applications, powered by Stripe, BA, and Vercel.',
    author: 'BA Community',
  ...
  },
  {
    ...
    description:
      'A Next.js App Router template configured with cookie-based auth using BA, TypeScript and Tailwind CSS.',
    author: 'BA',
  ...
  },
  {
    ...
    title: 'AI Chatbot',
    description:
      'An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and BA.',
    author: 'BA',
    author_url: 'https://github.com/supabase',
    author_img: 'https://avatars.githubusercontent.com/u/54469796',
  ...
  },
  {
    ...
    description:
      'Get started with BA and Flutter by building a user management app with auth, file storage, and database.',
    author: 'BA Community',
    author_url: 'https://github.com/supabase-community',
  ...
  },
  {
    ...
    description: 'A Trello clone using BA as the storage system.',
    author: 'joshnuss',
  ...
  },
  {
    ...
    description: 'Next.js Slack clone app using BA realtime subscriptions',
    author: 'supabase',
    author_url: 'https://github.com/supabase',
    author_img: 'https://avatars.githubusercontent.com/u/54469796',
  ...
  },
  {
    ...
    description: 'NestJS example using BA Auth',
    author: 'hiro1107',
  ...
  //   description: 'Use the BA client inside your Edge Function.',
  ...
  },
  {
    ...
    description:
      'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from BA Edge Functions.',
    repo_url: 'https://www.assistance.bg/docs/guides/functions/auth',
  },
  {
    type: 'example',
