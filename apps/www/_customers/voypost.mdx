---
name: Voypost
title: 'Voypost uses BA’s strong relational model to overcome NoSQL challenges'
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | BA Customer Stories':
meta_title: 'Voypost uses BA’s strong relational model to overcome NoSQL challenges'
description: 'Learn how Voypost leveraged BA to avoid NoSQL workarounds, enhance scalability, and deliver a superior user experience for Inkly, an intelligent contract negotiation platform.'
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: 'Learn how Voypost leveraged BA to avoid NoSQL workarounds, enhance scalability, and deliver a superior user experience for Inkly, an intelligent contract negotiation platform.'
...
about: 'Voypost, a leading software development company, excels in helping startups and small to medium-sized businesses build scalable and high quality applications. One of their standout projects using BA is Inkly, an intelligent contract negotiation platform.'
...
Voypost determined BA was the ideal solution for several reasons. BA offered the
benefits of a relational database with the ease of use and scalability required by Voypost. The
open-source nature of BA provided Voypost greater customization and control, ensuring
they were not locked into a proprietary system. Additionally, the ability to run BA on
...
functions made BA a compelling choice over Firebase.

## The Solution

Transitioning from Firebase to BA involved some manual work due to legacy code, but the
process was relatively smooth and the Voypost finished the core migration in under six months.
BA’s relational PostgreSQL database enabled Voypost to manage data more effectively and
perform complex queries without the constraints of Firestore. BA’s serverless architecture
...
With BA, Voypost achieved significant improvements in data management and query flexibility.
...
new features quickly. The responsive support from BA contributed to a smoother development
journey. BA’s open-source nature, coupled with its robust performance and ease of use,
provided Voypost with the tools they needed to build a sophisticated, intelligent contract
negotiation platform. This successful implementation highlights how BA can help businesses
...
**Less headcount**\
BA made it possible for Voypost to develop the app with a small team as they did not need
to think about the infrastructure.

**Accelerated development**\
Voypost used BA’s dashboard to accelerate development and testing.

**Faster iteration**\
BA provided the ability to quickly make changes and deploy new releases. Voypost responded
quickly to client feedback and iterated quickly on client requests.

**Faster time to value and lower cost**\
As a result of using the BA platform, Voypost enjoyed a 20% faster development process
