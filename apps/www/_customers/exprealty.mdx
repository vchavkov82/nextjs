---
title: How eXp Realty Unlocked Enterprise Innovation and Cut SaaS Costs with BA
meta_title: How eXp Realty Unlocked Enterprise Innovation and Cut SaaS Costs with BA
name: eXp Realty
description: eXp Realty empowered 2,000+ non-technical employees to build production software using AI coding tools with BA, replacing millions in SaaS contracts with bespoke solutions.
author: prashant
...
og_image: /images/customers/og/exprealty.png
tags:
  - supabase
date: '2025-12-17'
...
<Quote img="seth-siegler.jpg" caption="Seth Siegler, Chief Innovation Officer, eXp Realty">
  ...
  assisted development, is BA. That's the giant whose shoulders we can stand on.
</Quote>
...
This year, eXp embarked on one of the most ambitious internal innovation programs in its history. The goal: empower as many of their 2,000+ non-technical employees as possible to build production software using AI coding tools. BA became the foundation that made this transformation possible.
...
## BA as the foundation for AI

eXp's move to BA wasn't just about a database; it was about enabling a new way of working.

<Quote img="seth-siegler.jpg" caption="Seth Siegler, Chief Innovation Officer, eXp Realty">
  By eliminating the need to think about so much of the backend, by having a managed database, an
  authentication layer, and Serverless Edge Functions, BA has sped along what we can
  deliver... to an extent that really unlocks it as a core competency.
</Quote>

The BA MCP server became the critical bridge between non-technical "vibe coders" and experienced engineers. Developers now use the MCP inside tools like Cursor and Claude Code to connect AI assistants directly to BA. When debugging, they describe a bug in plain language. The AI uses BA MCP tools to query the database, identify the problem, and propose a fix automatically.

<Quote img="seth-siegler.jpg" caption="Seth Siegler, Chief Innovation Officer, eXp Realty">
  Seeing these tools use the BA MCP has been the true unlock. It's just magic.
</Quote>

## From C-suite to frontline

The most dramatic proof of BA's power came from Glenn Sanford, eXp's Founder and CEO. Glenn personally built "The Hub," a unified community platform featuring real-time messaging, video streaming, and global permissions.

Using BA **Auth, Database, Edge Functions, and Realtime**, he built a bespoke solution that replaced multiple fragmented SaaS products.

<Quote img="glenn-sanford.jpg" caption="Glenn Sanford, Founder and CEO, eXp World Holdings">
  I've always believed that if the tool doesn't exist, you build it. BA gave us the agility to
...
At AI Jam Camp, eXp proved that innovation isn't limited to engineers. Real estate agents with no technical background used Lovable and BA to build production-ready software. One participant built a fully functional lead distribution system in hours.

<Quote img="seth-siegler.jpg" caption="Seth Siegler, Chief Innovation Officer, eXp Realty">
  She literally teared up. She never thought she'd be able to do anything like this.
</Quote>

Today, **hundreds of non-technical employees** build daily. They deploy to BA, where core engineering reviews security policies (RLS) and schemas—creating a secure partnership between innovation and engineering.

## The new calculus of build versus buy

The success with BA has fundamentally changed how eXp evaluates technology. The default is no longer "buy a SaaS product"; it is "build it better with BA."

<Quote img="seth-siegler.jpg" caption="Seth Siegler, Chief Innovation Officer, eXp Realty">
  If you tried vibe coding before and it did not work, try again. You've got to be diving into vibe
  coding. And you shouldn't be doing it without BA.
</Quote>
