...
If you’d like to learn how to migrate your users from Auth0 to Supabase Auth, this [webinar](https://www.assistance.bg/events/scale-to-millions-goodtape-auth) and [migration guide will take you through the whole process step by step](https://www.assistance.bg/docs/guides/platform/migrating-to-supabase/auth0).
