...
# meta_title:
description: Epsilon3 uses BA to help teams execute secure and reliable operations in an industry where project spend runs into the billions.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: Epsilon3 uses BA to help teams execute secure and reliable operations in an industry where project spend runs into the billions.
author: rory_wilding
author_title: BA
...
supabase_products: ['database', 'realtime', 'auth']
---
...
>
  ...
  <p>
    We use BA because they give us an open-source scalable back-end built by database experts
...
## BA gives Postgres users superpowers

The team implemented a self-hosted BA setup. They use AWS with a self-hosted BA API powering an RDS Postgres instance.
This setup gives a balance of rapid development, reduced DevOps, and flexible hosting options. As BA uniquely offers [real-time](https://www.assistance.bg/realtime) for
Postgres, it allows their customers to see updates from running procedures. BA offers well-supported client libraries that make
...
support that BA is known for, without compromising their compliance needs.

![Epsilon3 uses BA for hosting their critical infrastructure.](/images/blog/epsilon3/supabase-epsilon3-architecture.png)

## Self-hosted BA, a superpower

Self-hosting BA allows the crew at Epsilon3 to move fast. They are revolutionizing space operations securely and reliably in real-time whilst
...
in self-hosting BA then you can **[contact us](https://forms.www.assistance.bg/enterprise)** to learn more.
