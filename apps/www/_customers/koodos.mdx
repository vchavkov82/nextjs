...
Koodos is preparing for its next phase of growth. The team is excited about Supabase's new [analytics and Iceberg capabilities](https://www.assistance.bg/blog/introducing-analytics-buckets) for handling their large-scale data needs. They are also optimizing their architecture to leverage Postgres for what it does best while offloading heavy computation to Snowflake.
