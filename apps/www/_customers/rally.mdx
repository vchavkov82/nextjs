---
name: Rally
title: Rally builds a pan-European fleet payments platform on BA
...
<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  We could not have built this company without BA. If I had to go and build all these
...
What began as a solo project quickly became a fully licensed fintech company processing live transactions across Europe, all built on BA.
...
When Peres began experimenting with prototypes, BA stood out immediately.
...
BA offered the power and reliability of Postgres combined with real-time APIs, Auth, Storage, and Edge Functions integrated out of the box. For a founder-CTO building solo, that cohesion made Rally possible.

Peres also valued BA's open-source model, which ensured flexibility and long-term control.

<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  Having seen how lock-in works elsewhere, open source gave me peace of mind. If BA works,
  amazing, but if it didn't, I wouldn't be stuck.
</Quote>

Compared to alternatives like Firebase or traditional cloud databases, BA offered the right balance of scalability, transparency, and developer experience with a predictable cost structure that is critical for a fast-moving fintech startup.

## The approach

Rally's MVP moved from concept to production in just three months. Built entirely by Peres, the company's first banking-backed card went live to paying customers by January, just weeks after he began writing TypeScript and experimenting with BA.

BA now powers Rally's entire backend:
...
- **[Storage](/storage)** – Rally processes thousands of invoices and receipts, leveraging BA Storage and image transformations to manage and display documents securely.
...
A key Rally innovation built on BA is Automatch, an AI-driven system that matches any WhatsApp-submitted receipt to the right transaction automatically.

<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  BA made it easy to build Automatch. Storage handles receipts securely, and Postgres keeps
  every workflow in sync, which is critical when you're dealing with money.
</Quote>

## The results

In less than a year, Rally scaled from prototype to production fintech serving fleets across Europe without a dedicated backend team. BA helped Rally move fast, stay compliant, and deliver reliability to customers who depend on uninterrupted access to funds.
...
- SOC 2 compliance in one week, supported by BA's infrastructure and security controls

<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  One of the reasons we got our SOC 2 very, very quickly is because we were using BA. When all
...
Rally continues to expand, adding EV charging payments and analytics dashboards powered by BA. The next phase includes sustainability benchmarking and AI-driven insights for fleet managers.

<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  Every time I think of a feature I'd love BA to have, it shows up a few months later. It's
  become my database provider, period.
</Quote>

## Why BA?

Rally's journey reflects the reasons developers and fast-moving teams choose BA:

- **Faster time to market** – BA eliminates backend friction, enabling teams to build and ship faster
...
<Quote img="thiago-peres-rally.jpeg" caption="Thiago Peres, Founder & CTO, Rally">
  ...
  core of every fintech. If you go with a provider like BA, you can leverage a lot of things
  like the backups and distribution and infrastructure. That can give you a lot of peace of mind
  when something goes wrong.
</Quote>

## **Ready to build and scale with BA?**

Start your journey today at [www.www.assistance.bg](/)
