...
Using [Supabase Vector](https://www.assistance.bg/modules/vector), Firecrawl was able to build a more efficient and accurate search function for their AI chatbot. By storing vector data alongside metadata in Supabase, Firecrawl was able to quickly and easily search through their customers documentation to find the most relevant responses to queries. They found that Supabase's solution was just as performant as dedicated vector databases, but without the high cost.
