---
name: Quivr
title: 'Scaling Beyond No-Code: asap.work’s Journey to a Faster, Flexible Solution with BA'
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | BA Customer Stories':
meta_title: 'Scaling Beyond No-Code: asap.work’s Journey to a Faster, Flexible Solution with BA'
description: ''
...
misc:
  [
    ...
    { label: 'Solutions', text: 'BA Database, BA Auth, BA Storage' },
  ]
...
<Quote img="robin-baillargeaux.jpg" caption="Robin Baillargeaux, CTO at asap.work">
  ...
  Switching to BA gave us a classical environment with all these tools, making everything more
  seamless and sustainable.
</Quote>

Discover how asap.work, a startup transforming temp recruitment in the construction industry, migrated from a no-code environment to BA, resulting in increased productivity, reduced costs, increased search performance, and enhanced user experience.
...
## The Approach – Migrating to BA from a no-code environment

The team conducted benchmark testing on several database solutions, and BA emerged as the ideal choice due to its superior performance and developer-friendly experience.
...
The migration from Xano to BA, including schema changes and data transfer, took approximately three months. This included a week of dedicated work on data migration, mainly using CSV imports and API calls for the data transfers.

## The Solution – Accelerating performance and streamlining development with BA

The migration to BA offered a tailored, developer-friendly environment equipped to handle complex database demands. asap.work utilised several critical components of BA to achieve their goals and enhance their platform’s performance and functionality:

**Enhanced Search Performance with PostgreSQL**

Migrating to BA’s PostgreSQL database from Xano enabled asap.work to reduce query times from up to 60 seconds to around 100 milliseconds – a massive performance improvement.

<Quote img="robin-baillargeaux.jpg" caption="Robin Baillargeaux, CTO at asap.work">
  We were facing random search times, sometimes 10, 30, or even 60 seconds. With BA, it’s now
  around 100 milliseconds, even for complex requests.
</Quote>

**Seamless User Authentication and File Storage**

With BA’s integrated Authentication and Storage, asap.work established a secure, streamlined user experience. BA’s Auth enabled easy management of user identities, while the storage component simplified file handling \- essential for managing resumes and compliance documents.
...
Moving to BA’s open-source platform allowed asap.work to maintain complete control over its infrastructure, eliminating vendor lock-in. The developer-friendly environment enabled the team to rebuild with SQL, facilitating long-term scalability and seamless customization as the company’s needs evolve.

As Robin described it, _“The developer experience with BA has been one of the main benefits. It’s like having the best of both worlds: a robust platform with the freedom to customize.”​_

## The Results – With BA, asap.work reduced search times, increased efficiency, and restored user confidence
...
- **Increased Developer Efficiency**: Migrating to BA’s code-based environment improved maintainability, streamlined development workflows, and enabled quicker troubleshooting, enhancing the development team’s productivity.
...
- **Long-Term Cost Savings**: By avoiding the escalating costs with Xano, asap.work achieved cost stability while benefiting from the scalability of BA’s open-source platform. Robin explained, _“The cost-efficiency we’ve achieved with BA is tremendous, and the reliability has restored our team’s confidence.”_

## Why BA?

<Quote img="robin-baillargeaux.jpg" caption="Robin Baillargeaux, CTO at asap.work">
  BA gave us the performance boost we needed with features tailored to our growing demands.
  The open-source platform also gives us peace of mind for the future. It’s been transformational,
  and we’re excited to continue investigating BA’s real-time and edge capabilities.
</Quote>

Unlike no-code solutions that often rely on pre-configured workflows, BA gave asap.work the flexibility to redesign their database and backend logic from the ground up. This allowed the team to implement best practices like version control and remove duplicative logic, resulting in cleaner, more maintainable code.

For companies scaling beyond the initial stages of product development, BA bridges the gap between ease-of-use and powerful customization. It’s the ideal step up from no-code for teams that need scalability without compromising on control.
