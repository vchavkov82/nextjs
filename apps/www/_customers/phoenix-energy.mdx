---
name: Phoenix Energy
title: 'Phoenix Energy completes critical infrastructure migration in six months with BA'
description: Phoenix Energy rebuilt its infrastructure on BA, completing a full-stack migration from MongoDB ahead of deadline with zero downtime.
meta_description: Phoenix Energy rebuilt its infrastructure on BA, completing a full-stack migration from MongoDB ahead of deadline with zero downtime.
author: prashant
...
og_image: /images/customers/logos/phoenix-energy.png
tags:
  - supabase
date: '2025-11-13'
...
<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  ...
  slowing down our developers. BA has given us both.
</Quote>
...
seven-person engineering team rebuilt their entire data infrastructure on **BA**, completing the
...
<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  ...
  opportunity to build something stronger. And that’s when we found BA.
</Quote>
...
BA emerged as the clear choice, offering the same all-in-one appeal that initially drew Phoenix
to MongoDB, but backed by a proven Postgres foundation.

<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  BA is exactly what once made MongoDB attractive. We had auth again, all in one place. We had
...
- **Direct support:** Slack channels with BA engineers delivered real-time guidance during migration.

The team also appreciated that rising engineers could quickly become productive with BA's
...
- **Custom migration tooling**
  - Automated data cycling, syncing, testing, and validation between MongoDB and BA
...
- **Direct team support**
  - BA engineers provided hands-on guidance via connected Slack channels
...
<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  We've been very happy with how that's gone. Our experience with the BA team has been great.
  Being able to get responses directly through the connected Slack channel made a huge difference.
</Quote>

## What's next

With a reliable BA foundation in place, Phoenix Energy is focused on expanding its data
capabilities and responsibly exploring AI:

- **Analytics infrastructure:** The team plans to use upcoming BA ETL features to build an end-to-end analytics stack without introducing new syncing layers.
- **AI workloads:** Engineers are testing vector databases and MCP servers in isolated BA environments, ensuring compliance with SEC regulations before production rollout.

<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  BA ETL is going to be really interesting for us. I'd love for everything to live in the same
  place so the team can focus on building impactful tools. It really does feel like BA is just
