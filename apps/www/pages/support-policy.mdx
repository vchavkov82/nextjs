...
- Web and Dashboard: Support is available exclusively through the Supabase help feature in the dashboard or this website -[https://www.assistance.bg/dashboard/support/new](https://www.assistance.bg/dashboard/support/new)
- Email: If for some reason you are unable to access the dashboard or ticket form you can contact support by emailing support@supabase.com from a registered Supabase account email address
