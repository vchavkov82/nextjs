...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>We may share this information with the following service providers through the provision of the Service: Stripe, Orb, Hubspot, Amazon Web Services, Google Cloud, Postmark,Twilio, Fly.io, and PandaDoc.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>We may share this information with the following service providers through the provision of the Service: Stripe, Orb, Tableau, PandaDoc, Hubspot, and Amazon Web Services.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>We may share this information with the following service providers through the provision of the Service: Hubspot, Tableau, Google Gsuite, Notion, Amazon Web Services, and Slack.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>We may share this information with the following service providers through the provision of the Service: Sentry, Tableau, Posthog, Plausible, BigQuery (Google Cloud), Fly.io, Vercel, Cloudflare, Configcat, and Amazon Web Services.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The processing is necessary for performance of a contract with you, namely our Terms of Service. If you access the Service as an authorized user of another customer, the processing is necessary for our and the customer's legitimate interests, namely presenting the Service to you on your device.</td>
      <td>We may share this information with the following service providers through the provision of the Service: Posthog, Plausible, Fly.io, Sentry, Hubspot, BigQuery (Google Cloud), Vercel, and Amazon Web Services.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td>We use information about how you use and connect to the Service to present the Service to you on your device.</td>
      <td>The processing is necessary for performance of a contract with you, namely our Terms of Service. If you access the Service as an authorized user of another customer, the processing is necessary for our and the customer's legitimate interests, namely presenting the Service to you on your device.</td>
      <td>We may share this information with the following service providers through the provision of the Service: Posthog, Plausible, Hubspot, Fly.io, Vercel, Sentry, Google Cloud, and Amazon Web Services.</td>
    </tr>
    <tr>
