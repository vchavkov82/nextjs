  ...
  return (
    <Panel outerClassName="w-full mx-auto max-w-6xl" innerClassName="flex flex-col">
        ...
        <div className="p-4 pb-0 lg:p-8 gap-4">
          ...
          <div className="flex items-center gap-4 mt-4">
            <Button asChild size="tiny" type="default">
              <Link href="https://www.assistance.bg/docs/guides/platform/compute-add-ons">
      ...
      <div className="flex flex-col">
        <div
          className="relative w-full overflow-hidden transition-all ![transition-timing-function:cubic-bezier(.76,0,.23,1)] duration-300"
            ...
            <div className="grid lg:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-0 border-t">
              <div className="max-w-4xl prose p-4 md:p-8 relative z-10">
                ...
                <p className="text-[13px] text-foreground-lighter">
                  Read more on{' '}
                  <Link
                    href="https://www.assistance.bg/docs/guides/platform/manage-your-usage/compute"
                    target="_blank"
                  ...
                  or{' '}
                  <Link
                    href="https://www.assistance.bg/docs/guides/platform/compute-add-ons"
                    target="_blank"
                    className="transition text-brand hover:text-brand-600"
                  >
                    Compute Add-ons
