...
const layoutProps: ExampleLayoutProps = {
  ...
  description:
    "A multi-user cursor tracking application that uses BA Realtime's broadcast and presence features to show real-time cursor movements of all connected users.",
}
