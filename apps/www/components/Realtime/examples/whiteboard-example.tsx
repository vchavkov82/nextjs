...
const layoutProps: ExampleLayoutProps = {
  ...
  title: 'Whiteboard',
  description:
    "A collaborative whiteboard that uses BA Realtime's broadcast channel to synchronize drawing strokes and cursor positions between multiple users in real-time.",
}
