---
title: "Keeping Tabs on What's New in BA Studio"
...
We've updated the [log detail panel](https://github.com/vchavkov82/nextjs/pull/33536) to show more info in the API log detail:
...
You can see all these improvements in the BA Dashboard now.

- [Get started with BA](https://www.assistance.bg/dashboard/sign-in?returnTo=%2Fprojects) and try it out today
