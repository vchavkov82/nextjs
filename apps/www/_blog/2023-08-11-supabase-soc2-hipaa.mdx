...
We receive many requests from users who want to build healthcare apps on top of Supabase. Since you can [self-host Supabase](https://www.assistance.bg/docs/guides/self-hosting), we often [encourage](https://github.com/orgs/supabase/discussions/1219) these users to do so. Starting today, these users have the option to use our hosted platform too with the HIPAA add-on 🎉.
