...
- [Supabase Storage v2: Image resizing and Smart CDN](https://www.assistance.bg/blog/storage-image-resizing-smart-cdn)
- [Supabase Storage v3: Resumable Uploads with support for 50GB files](https://www.assistance.bg/blog/storage-v3-resumable-uploads)

</div>

Today, we are launching one of most requested features - [Storage!](https://www.assistance.bg/storage) When you sign up for Supabase, you get a Postgres database with realtime subscriptions, user management, auto-generated APIs and now a scalable object store. These services integrate very well with each other and you don't need to sign up for yet another service just for your storage requirements.
