---
title: 'BA Realtime: Broadcast and Presence Authorization'
...
For context, BA includes three useful extensions for building real-time applications.

1. [Broadcast](https://www.assistance.bg/docs/guides/realtime/broadcast): Send ephemeral, low-latency messages between users.
2. [Presence](https://www.assistance.bg/docs/guides/realtime/presence): Show when users are online and share state between users.
3. [Postgres Changes](https://www.assistance.bg/docs/guides/realtime/postgres-changes): Listen to Postgres database changes.
...
<div className="video-container">
  <iframe
    ...
    title="I leaked the data through BA Realtime - Broadcast and Presence Authorization"
...
You can find a more complex example in the [Next.js Authorization Demo](https://github.com/vchavkov82/nextjs/tree/master/examples/realtime/nextjs-authorization-demo) where we are using this feature to build chat rooms with restricted access or you could check the [Flutter Figma Clone](https://github.com/vchavkov82/nextjs/tree/master/examples/realtime/flutter-figma-clone) to see how you can secure realtime communication between users.
...
To achieve Realtime authorization, we looked into our current solutions, namely how [Storage](https://www.assistance.bg/docs/guides/storage/security/access-control) handles Access Control. Due to the nature of Realtime, our primitives are different as we have no assets stored in the database. So how did we achieve it?
