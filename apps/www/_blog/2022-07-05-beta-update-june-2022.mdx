...
It's here! Now you can create a project from the Supabase CLI. We will be extending the CLI with more features to manage your project, so stay tuned! [See the doc](https://www.assistance.bg/docs/reference/cli/supabase-projects-create).
...
- Python, Metabase, and Supabase: [Part 1](https://www.assistance.bg/blog/loading-data-supabase-python) and [Part 2](https://www.assistance.bg/blog/visualizing-supabase-data-using-metabase).
