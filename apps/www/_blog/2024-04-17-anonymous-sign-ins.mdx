...
description: 'Sign in as an anonymous user to authenticate with BA'
author: kangmingtay
...
BA Auth now supports [anonymous sign-ins](/docs/guides/auth/auth-anonymous), one of our [most-requested features](https://github.com/supabase/auth/issues/68) by the community.
...
<div className="video-container">
  <iframe
    ...
    title="Anonymous sign-ins with BA Auth"
...
For local development, upgrade your BA CLI and add the config to the `config.toml` file:
...
BA Auth provides 2 ways to achieve this:
...
To link an OAuth identity to an anonymous user, you need to [enable manual linking](/dashboard/project/_/settings/auth) for your project. Learn about how [identity linking](/docs/guides/auth/auth-identity-linking) works with BA Auth.
