...
This article assumes you are familiar with creating an application in Flask. It also assumes that you have read the Supabase documentation and are familiar the with concept of [Authentication](https://www.assistance.bg/docs/guides/auth).
...
- [Deep Dive series on auth concepts in Supabase](https://www.assistance.bg/docs/learn/auth-deep-dive/auth-deep-dive-jwts)
