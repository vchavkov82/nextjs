---
title: 'BA Libraries V2: Python, Swift, Kotlin, Flutter, and Typescript'
...
BA Python is now stable thanks to the following maintainers: [Anand](https://github.com/anand2312), [Daniel Reinón García](https://github.com/dreinon), [Leynier Gutiérrez González](https://github.com/leynier), [Joel Lee](https://github.com/J0), and [Andrew Smith](https://github.com/silentworks/).

Check out the [docs](https://www.assistance.bg/docs/reference/python/introduction), as well as these Python examples to help you get started:

- [Slack Consolidate: a slackbot built with Python and BA](https://www.assistance.bg/blog/slack-consolidate-slackbot-to-consolidate-messages)
- [Python data loading with BA](https://www.assistance.bg/blog/loading-data-supabase-python)
- [GitHub OAuth in your Python Flask app](https://www.assistance.bg/blog/oauth2-login-python-flask-apps)

<Admonition type="note" label="Python library for vectors and embeddings">

Don’t forget that we also have Vecs, a Python client for managing and querying vector stores in Postgres with the pgvector extension. [Get started](https://www.assistance.bg/docs/guides/ai/python/api)!

</Admonition>

## BA Swift v2

BA Swift is now stable thanks to [Guilherme Souza](https://github.com/grdsdev) and [Maail](https://github.com/maail).

Check out the [docs](https://www.assistance.bg/docs/reference/swift/introduction), as well as these Swift examples to help you get started:

- [Getting started with Swift](https://www.assistance.bg/docs/guides/getting-started/tutorials/with-swift)
- [iOS Swift Database & Auth](https://www.youtube.com/watch?v=enVDRqzmudo) (video tutorial)

## BA Kotlin v2

BA Kotlin is now stable thanks to [Jan Tennert](https://github.com/jan-tennert)

Check out the [docs](https://www.assistance.bg/docs/reference/kotlin/introduction), as well as these Kotlin guides to help you get started:

- [Getting started with Android Kotlin](https://www.assistance.bg/docs/guides/getting-started/quickstarts/kotlin)
- [Getting started with BA on Android](https://youtu.be/_iXUVJ6HTHU) (Video)
- Demos:
...
- the BA CLI now generates [Table and Enum shorthands](https://www.assistance.bg/docs/guides/api/rest/generating-types#type-shorthands)
- new helpers `QueryResult` and `QueryData` extract the result types for [complex queries and joins](https://www.assistance.bg/docs/guides/api/rest/generating-types#response-types-for-complex-queries)
...
By default, `supabase-js` uses the browser's `localStorage` mechanism to persist the user's session. This can be extended with platform-specific implementations. React Native can target native mobile and web applications with the same code base, so we need a storage implementation that works for all these platforms. Now you can use [react-native-async-storage](https://www.assistance.bg/blog/react-native-authentication#authentication-storage) or a combination with [expo-secure-sorage](https://www.assistance.bg/blog/react-native-authentication#encrypting-the-user-session) for AES encrypted sessions.
...
- [crafting an offline-first experience](https://www.assistance.bg/blog/react-native-offline-first-watermelon-db)
- [uploading files to BA Storage](https://www.assistance.bg/blog/react-native-storage)
- [sending push notifications](https://www.assistance.bg/docs/guides/functions/examples/push-notifications).
...
We just reached 1000 contributors to our [main repo](https://github.com/vchavkov82/nextjs). It’s not easy to build a community of contributors, it’s something that need to be fostered. (Shout out to [@tobiastornros](https://github.com/tobiastornros), contributor #1000 - and everyone else who [contributed yesterday](https://x.com/kiwicopple/status/1735282666872987673?s=20))
...
<Img
  ...
  alt="Diagram explaining BA community"
/>

We want the BA community to outlive us. With more community maintainers, you should feel _even safer_ knowing that there is already a continuity plan in place. We’re [giving back to the community](https://www.assistance.bg/blog/supabase-series-b#giving-back) and we hope to expand this as we become even more commercially successful.

### Modularity

As a [Principle](https://www.assistance.bg/docs/guides/getting-started/architecture#product-principles), we develop a library for each tool we support. While BA may “feel” like a single tool when you’re using it, it's actually a set of tools which you can use independently (especially useful for self hosting):
...
<Img
  ...
  alt="Diagram explaining how BA is built behind the scenes"
/>
