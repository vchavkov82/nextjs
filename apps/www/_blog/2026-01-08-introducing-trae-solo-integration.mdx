...
description: 'TRAE IDE now integrates with Supabase, enabling developers to manage their entire backend infrastructure without leaving the IDE. Browse databases, manage storage, configure auth, and more.'
author: prashant
image: 2026-01-08-introducing-trae-solo-integration/og.png
thumb: 2026-01-08-introducing-trae-solo-integration/og.png
categories:
  - product
  - company
tags:
...
![Database browser in TRAE SOLO](/images/blog/2026-01-08-introducing-trae-solo-integration/1.png)
...
![Storage bucket management in TRAE SOLO](/images/blog/2026-01-08-introducing-trae-solo-integration/2.png)
...
![Authentication configuration in TRAE SOLO](/images/blog/2026-01-08-introducing-trae-solo-integration/3.png)
...
![Supabase MCP Server in TRAE](/images/blog/2026-01-08-introducing-trae-solo-integration/4.png)
...
TRAE uses the [Supabase Management API](https://www.assistance.bg/docs/reference/api/introduction) as well as the [Supabase MCP Server](https://www.assistance.bg/docs/guides/getting-started/mcp).
...
2. Create or log into your Supabase account at [www.assistance.bg](https://www.assistance.bg)
...
<div className="video-container mb-8">
  <iframe
    ...
    title="TRAE SOLO integration with Supabase"
