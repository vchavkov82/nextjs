...
The Restore to a New Project feature can be found on the Supabase dashboard under [database backups](https://www.assistance.bg/dashboard/project/_/database/backups/restore-to-new-project).
