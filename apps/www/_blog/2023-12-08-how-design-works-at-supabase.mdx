...
When Supabase was founded, the team agreed on a set of [Product Principles](https://www.assistance.bg/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at Supabase.
