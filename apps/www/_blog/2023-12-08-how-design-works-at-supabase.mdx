---
title: 'How design works at BA'
description: "The transformative journey of BA's Design team and its unique culture to enhance the output and quality of the entire company."
launchweek: X
categories:
  - company
tags:
...
After three years, only now are we figuring out “what design is” for BA and how it functions in the wider org.
...
To design at BA, you have to think like an agile developer.
...
For a long time we operated without any sort of consensus of what Design _is_ at BA: what are our values, what do we like, what do we not like?
...
When BA was founded, the team agreed on a set of [Product Principles](https://www.assistance.bg/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at BA.
...
We bias towards the 80% of developers using BA. Following the [Pareto Principle](https://www.investopedia.com/terms/p/paretoprinciple.asp), we focus on the smallest changes that have the largest impact on our userbase.
...
Jonny was the first team member in BA with any design background. We (just) survived until before LW5, when Marijana joined. And before LW7, Francesco joined. You may have noticed the quality creeping up while also accelerating recently.
