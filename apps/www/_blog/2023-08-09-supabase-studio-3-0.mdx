...
In Launch Week 7, [we added Supabase AI to the Studio](https://www.assistance.bg/blog/supabase-studio-2.0). Through our ⌘K menu, you could ask Supabase AI to do all sorts of common tasks — create tables, views, and indexes, write database functions, write RLS policies, and more.
...
With Supabase AI, you won't even need the whole weekend to scale to millions. Head over to the [SQL Editor](https://www.assistance.bg/dashboard/project/_/sql) and give it a try!
...
During Launch Week 6, we [announced](https://www.assistance.bg/blog/postgres-foreign-data-wrappers-rust) Supabase Wrappers — a framework for building foreign data wrappers with Postgres. Wrappers allow your Supabase project to act as a one-stop hub for your data.
...
- [Supabase Local Dev: migrations, branching, and observability](https://www.assistance.bg/blog/supabase-local-dev)
