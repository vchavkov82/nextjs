...
3. Creating scheduled events using [Supabase Cron](https://www.assistance.bg/docs/guides/cron)
...
- [Discover use cases](https://www.assistance.bg/realtime) for Supabase Realtime
- Read the [Supabase Realtime documentation](https://www.assistance.bg/docs/guides/realtime) to learn more
