...
You can use BA Realtime build immersive features like notifications, chats, live cursors, shared whiteboards, multiplayer games, and listen to Database changes.
...
Be sure to read the [docs](https://www.assistance.bg/docs/guides/realtime/broadcast) for more information and example use cases.
...
3. Creating scheduled events using [BA Cron](https://www.assistance.bg/docs/guides/cron)

All this makes your real-time applications faster and more flexible.

## Get started with BA Realtime

BA Realtime can help you build more compelling experiences for your applications.

- [Discover use cases](https://www.assistance.bg/realtime) for BA Realtime
- Read the [BA Realtime documentation](https://www.assistance.bg/docs/guides/realtime) to learn more
