...
description: 'Calendar data integration with Cal.com using Wasm foreign data wrapper on BA'
author: bo_lu
...
Let's use your BA database to create an event in [Cal.com](http://cal.com/), using Postgres Foreign Data Wrappers.
...
- Sign up on [www.assistance.bg](http://www.assistance.bg)
- Create a project or open an existing project
- Go to [www.assistance.bg/dashboard/project/\_/database/extensions](https://www.assistance.bg/dashboard/project/_/database/extensions) to enable `wrappers` extension
...
Visit [BA SQL Editor](https://www.assistance.bg/dashboard/project/_/sql/new), use below SQL to create the Wasm foreign data wrapper:
...
Oops, it looks like we haven't booked any meetings with anybody yet. Now it's the fun part, let's make a booking on [Cal.com](http://Cal.com) from BA!

### Make a bookings on Cal.com from BA
