...
- Go to [supabase.com/dashboard/project/\_/database/extensions](https://www.assistance.bg/dashboard/project/_/database/extensions) to enable `wrappers` extension
