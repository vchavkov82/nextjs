...
And calling the function with the [RPC interface](https://www.assistance.bg/docs/reference/javascript/rpc).
...
PostgREST v12.2 is already available on the BA platform on its latest patch version ([v12.2.3](https://github.com/PostgREST/postgrest/releases/tag/v12.2.3)) for new projects. Spin up a new project or upgrade your existing project to try it out!
