...
image: 2026/security-retro/og.png
thumb: 2026/security-retro/thumb.png
---
...
All Supabase databases run fail2ban to automatically block IPs after failed login attempts. You can also [configure IP allowlists](https://www.assistance.bg/docs/guides/platform/network-restrictions) to restrict database access to specific trusted addresses.
