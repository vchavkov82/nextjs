...
BA’s GraphQL API is powered by `pg_graphql`. In this post, we will look at the internal workings of `pg_graphql`. Since it is an extension written in the Rust programming language, familiar with Rust will help - although it’s not a requirement to understand this post.
...
- [What's New in pg_graphql v1.2](https://www.assistance.bg/blog/whats-new-in-pg-graphql-v1-2)
- [BA GraphQL docs](https://www.assistance.bg/docs/guides/graphql)
