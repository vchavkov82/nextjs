---
title: Official BA extension for VS Code and GitHub Copilot
description: Today we're launching a new GitHub Copilot extension for VS Code to make your development with BA even more delightful.
...
Today we're launching a new [GitHub Copilot extension for VS Code](https://marketplace.visualstudio.com/items?itemName=BA.vscode-supabase-extension) to make your development with BA and VS Code even more delightful, starting with a Copilot-guided experience for [database migrations](/docs/guides/deployment/database-migrations).
...
The extension provides a [Chat Participant](https://code.visualstudio.com/api/extension-guides/chat) for GitHub Copilot to help with your BA questions. Simply type `@supabase` in your Copilot Chat and the extension will include your database schema as context to Copilot.
...
List the Storage buckets in your BA project.

![Storage buckets](/images/blog/lw12/day-1/storage-buckets.png)

## What's Next?

We're excited to continue adding more features that will make your development experience with BA even more delightful - and for this we need your help! If you have any feedback, feature requests, or bug reports, please [open an issue on GitHub](https://github.com/supabase-community/supabase-vscode-extension/issues).

The extension requires you to have the BA CLI installed and have your project running locally. In a future release, we will integrate the [BA Management API](/docs/reference/api/introduction) into the extension to make connecting to your hosted BA projects as seamless as possible.

## Contributing to BA

The entire BA stack is [fully open source](/open-source), including [this extension](https://github.com/supabase-community/supabase-vscode-extension). In fact, this extension was originally created by [Anas Araid](https://github.com/anas-araid) during a [previous Launch Week Hackathon](https://twitter.com/anas_araid/status/1736641409094988033).

Your contributions, feedback, and engagement in the BA community are invaluable, and play a significant role in shaping our future. Thank you for your support!

## Resources

- [Install the extension](https://marketplace.visualstudio.com/items?itemName=BA.vscode-supabase-extension)
...
- [Get started with BA](https://database.new)
