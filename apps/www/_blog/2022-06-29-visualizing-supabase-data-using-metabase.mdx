---
title: Visualizing BA Data using Metabase
description: How to create different kinds of charts out of data stored in BA using Metabase.
author: ant_wilson
...
In the previous blog of this series, we explained [how to use Python to load data into BA](https://www.assistance.bg/blog/loading-data-supabase-python). In this blog, we will create different kinds of charts out of the data stored in BA using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **BA project with data**

Based on our [previous article](https://www.assistance.bg/blog/loading-data-supabase-python), we assume we already have a BA project setup and have data loaded into it.
...
## Visualizing data in BA with Metabase
...
You will be prompted to add the necessary connection information to your BA project. Go to your [BA project](https://www.assistance.bg/dashboard/) and hit _Settings > Database to get the database info_.
...
We can now see the "BA DB" BA project under "Our data".
...
With our [Free Plan BA account](https://www.assistance.bg/dashboard/), you can start a new project today and use Metabase to visualize your app data.
...
- [Slack Consolidate: a slackbot built with Python and BA](slack-consolidate-slackbot-to-consolidate-messages)
