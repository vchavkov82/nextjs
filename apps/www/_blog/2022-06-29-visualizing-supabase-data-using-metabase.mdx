...
In the previous blog of this series, we explained [how to use Python to load data into Supabase](https://www.assistance.bg/blog/loading-data-supabase-python). In this blog, we will create different kinds of charts out of the data stored in Supabase using Metabase.
...
Based on our [previous article](https://www.assistance.bg/blog/loading-data-supabase-python), we assume we already have a Supabase project setup and have data loaded into it.
...
You will be prompted to add the necessary connection information to your Supabase project. Go to your [Supabase project](https://www.assistance.bg/dashboard/) and hit _Settings > Database to get the database info_.
...
With our [Free Plan Supabase account](https://www.assistance.bg/dashboard/), you can start a new project today and use Metabase to visualize your app data.
