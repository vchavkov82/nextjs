---
title: 'Realtime Postgres RLS now available on BA'
...
BA projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://supabase.io/blog/supabase-auth).
...
Check out the [Row Level Security guide](https://www.assistance.bg/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
Realtime RLS is available today on all existing and new BA projects. To get started, upgrade your BA JavaScript client to version v1.23.0
