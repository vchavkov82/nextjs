...
Of course, you don’t need to be backed by Y Combinator to build a successful startup. Fast-growing companies like [Udio](https://www.assistance.bg/customers/udio), [Euka](https://www.assistance.bg/customers/euka), and [Pebblely](https://www.assistance.bg/customers/pebblely) are also built on Supabase. Supabase is proud to partner with more than 80 other startup accelerators and early-stage investors across the global startup ecosystem, a program that we are rapidly expanding. Why? Because we believe in the power of builders to change the world - and we want to help you build faster!
