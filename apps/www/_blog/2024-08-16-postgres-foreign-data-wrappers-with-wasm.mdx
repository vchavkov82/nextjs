...
The Wasm FDW feature is available today on the Supabase platform. We have 2 new built-in Wasm FDWs: [Snowflake](https://www.assistance.bg/docs/guides/database/extensions/wrappers/snowflake) and [Paddle](https://www.assistance.bg/docs/guides/database/extensions/wrappers/paddle).
