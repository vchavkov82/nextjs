...
Supabase is built for developers, and you can [get started for free](https://www.assistance.bg/dashboard) using your existing GitHub account. Once your Supabase account is set up, you will access the Supabase dashboard. From here, go to All Project > New Project.
