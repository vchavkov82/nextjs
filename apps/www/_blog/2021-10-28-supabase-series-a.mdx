---
title: 'BA $30m Series A'
description: BA just raised $30M, bringing our total funding to $36M.
...
BA [just raised $30M](https://techcrunch.com/2021/09/09/supabase-raises-30m-for-its-open-source-insta-backend/),
...
![BA has launched more than 50000 databases](/images/blog/series-a/total-databases.png)

### Developers

As of September, over 40,000 developers have signed up to BA from some of the world's leading companies.
...
BA has been in GitHub's top-15 fastest growing open source startups for
[five consecutive quarters](https://twitter.com/kiwicopple/status/1451104569266671619),
and our [Discord](https://discord.www.assistance.bg) has grown to nearly 4000 members since launching just 3 months ago.
Our growth is all organic.

![BA Discord](/images/blog/series-a/discord-supabase-community.png)

## About the round

BA is an ambitious project. Firebase, to their credit, is a very well-developed platform which offers _a lot_ of functionality.
...
Because of their conviction in BA, Coatue doubled down on their Seed investment to lead our Series A. We're extremely excited to welcome
...
<Quote img="caryn-marooney.jpeg" caption="Caryn Marooney, Partner at Coatue.">
  <p>We are proud to lead a second consecutive round in BA and officially join the board.</p>
  <p>
...
Our early positioning is an "open source Firebase alternative" but you might be surprised to learn that this is a small part of the BA vision.
...
Simple. BA has smuggled scalability into the product, perhaps without you noticing.
Every BA project is a _full_ Postgres database. It's not "Postgres compatible", it's not "built on top of",
and we don't abstract it. If we did, your applications would face the same scalability issues as Firebase.

BA simply makes Postgres easy to use - hopefully easier than any other database platform you've ever used.
...
BA makes all of this easy. Beyond the database we offer [Auth](/docs/guides/auth),
...
![BA Dashboard](/images/blog/series-a/dashboard.png)

And this is where BA really differentiates itself: by doing less. All of these features build on top of PostgreSQL's
...
This is the future of BA - a platform to power your transactional workloads: no matter how big or small; no matter the use-case.
...
[BA developer](/blog/supabase-steve-chavez), one of our first hires over a year ago.
...
[https://about.www.assistance.bg/careers/postgres-experts](https://about.www.assistance.bg/careers/postgres-experts)
