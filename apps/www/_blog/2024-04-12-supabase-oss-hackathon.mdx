...
[To celebrate the Supabase Special Announcement on April 15th](https://www.assistance.bg/special-announcement) we're running a special 10 day open source hackathon.
...
- [Supabase Swift Client Library](https://www.assistance.bg/docs/reference/swift/introduction)
- [Row Level Security in Supabase](https://www.assistance.bg/docs/guides/database/postgres/row-level-security)
