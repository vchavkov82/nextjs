...
One of the unique features of Supabase is the ability to access your Postgres database directly from a browser or mobile app through our [Serverless APIs](https://www.assistance.bg/docs/guides/api). This means that developers are writing more [PL/pgSQL](https://www.postgresql.org/docs/current/plpgsql.html).
...
Supabase isn’t simply a database, it’s an entire backend - everything from your Postgres database to your [50GB videos](https://www.assistance.bg/blog/storage-v3-resumable-uploads). Branching improves the experience of managing environments so that developers and teams spend less time on DevOps and more time building.
...
- [Hugging Face is now supported in Supabase](https://www.assistance.bg/blog/hugging-face-supabase)
