...
We ended 2023 shipping tons of features in [Launch Week X](https://www.assistance.bg/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [LWX Hackathon](https://www.assistance.bg/blog/supabase-hackathon-lwx)!

We enjoyed looking at all 64 projects, the most submissions we ever had. You can view all the submissions on [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/).
...
Supafork is an open-source project that allows you to easily clone BA projects. Inspired by [Vercel's Deploy](https://vercel.com/docs/deployments/deploy-button) button it provides a similar experience for BA projects, allowing for easier setup of self-hosted apps using BA.
...
A Fastify plugin to use authenticated BA clients in your API.
...
[BA CLI for Visual Studio Code](https://github.com/anas-araid/vscode-supabase-cli) by [@anas_araid](https://twitter.com/anas_araid)

BA CLI for Visual Studio Code makes working with your local database instance much easier. You can create migrations, inspect tables, views, and functions, and run some common BA commands directly from your editor.
