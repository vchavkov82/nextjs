...
![Supabase Vector: the open source Vector Toolkit for Postgres](/images/blog/2023-09-06-may-2023-beta-update/supabase-vector.png)
...
[Supabase Vector](https://www.assistance.bg/modules/vector)
...
- [Dashboard] Supabase Wrappers UI that supports pulling data in from Firebase, Stripe, S3, and Clickhouse. [Create a Wrapper](https://www.assistance.bg/dashboard/project/_/database/wrappers)
...
- [Supabase Vecs: a vector client for Postgres](https://www.assistance.bg/blog/vecs)

- [ChatGPT plugins now support Postgres & Supabase](https://www.assistance.bg/blog/chatgpt-plugins-support-postgres)

- [Building ChatGPT Plugins with Supabase Edge Runtime](https://www.assistance.bg/blog/building-chatgpt-plugins-template)
...
![Made with Supabase](/images/blog/2023-09-06-may-2023-beta-update/quivr-second-brain.png)
...
- We worked with Cloudflare on a new integration that makes it super easy to connect your Supabase database from Cloudflare Workers. [Doc](https://www.assistance.bg/partners/integrations/cloudflare-workers)
