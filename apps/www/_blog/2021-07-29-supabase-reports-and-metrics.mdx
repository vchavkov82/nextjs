...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.supabase.com/) and give BA a try by [creating a project](https://www.assistance.bg/dashboard/).
