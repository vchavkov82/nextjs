...
The persistent storage option is built on top of the S3 protocol. It allows you to mount any [S3-compatible bucket](https://www.assistance.bg/docs/guides/storage/s3/compatibility), including [BA Storage Buckets](https://www.assistance.bg/docs/guides/storage), as a directory for your Edge Functions. You can perform operations such as reading and writing files to the mounted buckets as you would in a POSIX file system.
...
If you are using BA Storage, [follow this guide](https://www.assistance.bg/docs/guides/storage/s3/authentication) to enable and create an access key and id.
