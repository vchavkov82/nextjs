...
That is a lot of very confusing code! So we decided to [create a package called `@supabase/ssr`](https://www.assistance.bg/docs/guides/auth/server-side/overview) that does all of this for you. Then we took it one step further and created a [Next.js and Supabase Starter Template](https://www.assistance.bg/docs/guides/getting-started/quickstarts/nextjs), so you can just focus on building your awesome app! 🚀
...
- [Fetching and caching Supabase data in Next.js 13 Server Components](https://www.assistance.bg/blog/fetching-and-caching-supabase-data-in-next-js-server-components)
- [Infinite scroll with Next.js, Framer Motion, and Supabase](https://www.assistance.bg/blog/infinite-scroll-with-nextjs-framer-motion)
