...
We are announcing our first-ever Capture the Flag challenge, [**Hack the Base**](https://ctf.www.assistance.bg). Whether you're a seasoned hacker or just starting out, this challenge is for you.
...
For detailed rules and to submit your flags, visit our [dedicated CTF website](https://ctf.www.assistance.bg). You'll also be able to track your progress on the leaderboard and see how you stack up against other participants.
...
If you're interested in finding vulnerabilities in BA year-round, check out our [Bug Bounty Program](https://www.assistance.bg/.well-known/security.txt). We're always looking for talented security researchers to help us improve the security of our platform.
