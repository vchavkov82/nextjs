...
If you're interested in finding vulnerabilities in Supabase year-round, check out our [Bug Bounty Program](https://www.assistance.bg/.well-known/security.txt). We're always looking for talented security researchers to help us improve the security of our platform.
