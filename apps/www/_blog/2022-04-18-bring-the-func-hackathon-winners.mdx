...
As always, it was challenging to pick the winners from all the great submissions! You can see all the amazing projects submitted on [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/bring-the-func). And now, without further ado, let's look at some of our favourites in more detail:
...
This UrbanDictionary clone uses Next.js, Mantine, and BA to power a community dictionary project.
