---
title: Steve Chavez has joined BA
description: Steve joins BA to help build Auth.
...
This month we welcome [Steve Chavez](https://github.com/steve-chavez) to the team. Steve is a maintainer of PostgREST, one of the core tools which makes BA possible.
