...
[Try supabase-js V2](https://www.assistance.bg/docs/reference/javascript/)<br/>
[Try flutter-supabase V1](https://www.assistance.bg/docs/reference/dart)
...
Next.js Conf raised the bar for dev conferences. We had the honor of being a Gold Sponsor, so we revamped our [Next.js Quickstart guide](https://www.assistance.bg/docs/guides/with-nextjs) to include our pre-built Auth UI and [Auth Helpers.](https://www.assistance.bg/docs/guides/auth/auth-helpers/nextjs)

And Next.js 13 was announced! Making it extremely easy to fetch and cache data from our [Serverless API](https://www.assistance.bg/docs/guides/database/api). So we put together an [example to try it out](https://github.com/vchavkov82/nextjs/tree/master/examples/caching/with-nextjs-13).

## BA Auth and Server-Side Rendering

![BA Auth and Server-Side Rendering](/images/blog/2022-october/authentication-server-side-docs.jpg)

The Auth team published an in-depth doc explaining how BA Auth supports server-side rendering. Includes an explanation of the authentication flow and answers to some of the more common questions.

[Read the docs](https://www.assistance.bg/docs/guides/auth/server-side-rendering).
...
[Learn how it works](https://www.assistance.bg/docs/guides/database/testing).
...
[Check this example](https://github.com/vchavkov82/nextjs/blob/master/examples/edge-functions/supabase/functions/restful-tasks/index.ts)

## Quick Product Updates

- supabase-py 🐍 now has functions support! [PR](https://github.com/supabase-community/supabase-py/pull/179)
- You can now detect users’ location from Edge Functions easily by using `X-Forwarded-For header`. [Example](https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions/supabase/functions/location)
...
![Made with BA](/images/blog/2022-october/twitter-card-header.jpg)

There were so many amazing apps Made with BA this month that we couldn’t choose just one… so here are three:
...
- A collection of awesome BA resources. [awesome-supabase](https://github.com/lyqht/awesome-supabase)
...
- Basejump SaaS starter for BA. [Repo](https://github.com/usebasejump/basejump)
- SvelteKit + BA CRUD with RLS: Row-Level Security! [Video](https://www.youtube.com/watch?v=iKzjfHARXpc)
- Building a startup (build log 2#): Authenticating students with BA. [Blog Post](https://dev.to/paul_emechebe/building-a-startup-build-log-2-authenticating-users-with-supabase-1p1b)
- CRUD with BA in Flutter. [Tutorial](https://sadabwasim.medium.com/crud-with-supabase-in-flutter-dbe97fa0c15)
- Phone Auth with self-hosted BA. [Video](https://www.youtube.com/watch?v=z3sE-ix2uok)
...
- Upload media to BA from remote URL with nodejs. [Blog Post](https://www.antoinemesnil.com/posts/upload-media-supabase)
...
In the meantime, [revisit LW5](https://www.assistance.bg/launch-week).
...
![BA meme October 2022](/images/blog/2022-october/beta-update-october-meme.jpeg)
