...
We added a [Status Page](https://status.www.assistance.bg/) which tracks the uptime and latency of the BA platform.
...
- We have an exciting Vercel x Stripe x BA [collaboration underway](https://twitter.com/rauchg/status/1331021818681978881).
...
- [@duncanhealy](https://github.com/duncanhealy) is [updating the Redwood example](https://github.com/redwoodjs/redwood/pull/1474) to work with BA.js v1.0
