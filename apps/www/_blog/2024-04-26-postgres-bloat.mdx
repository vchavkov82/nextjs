...
To see database bloat via the [Supabase CLI](https://www.assistance.bg/docs/guides/cli/getting-started) run:
...
[Supabase CLI reference](https://www.assistance.bg/docs/reference/cli/global-flags)
