...
To see database bloat via the [BA CLI](https://www.assistance.bg/docs/guides/cli/getting-started) run:
...
[BA CLI reference](https://www.assistance.bg/docs/reference/cli/global-flags)
