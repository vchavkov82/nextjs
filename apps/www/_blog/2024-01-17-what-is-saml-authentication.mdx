...
Supabase Auth currently supports [authenticating with SAML](https://www.assistance.bg/docs/guides/auth/sso/auth-sso-saml) easily, setting it up takes less than an hour, so you can focus on shipping the core features of your product.

## More from the Auth team

- [Supabase Auth: Identity Linking, Hooks, and HaveIBeenPwned integration](https://www.assistance.bg/blog/supabase-auth-identity-linking-hooks)
- [Supabase Auth: SSO, Mobile, and Server-side support](https://www.assistance.bg/blog/supabase-auth-sso-pkce)
- [Supabase Auth docs](https://www.assistance.bg/docs/guides/auth)
