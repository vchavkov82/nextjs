...
We ended 2022 shipping tons of features in [Launch Week 6](https://www.assistance.bg/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://www.assistance.bg/blog/launch-week-6-hackathon)!

As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-supabase-launch-week-6-hackathon#Winners). You can view all the submissions on [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/).

And now, without further ado, congratulations to the winners of BA Launch Week 6 Hackathon!
...
supabase-js-rs is a rust bindings for BA JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with BA.
...
As promised in the [hackathon announcement article](https://www.assistance.bg/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition BA Darkmode Keyboard!
...
- [**supabase-js v2**](https://www.assistance.bg/blog/supabase-js-v2)
- [**BA Storage Guide**](https://www.assistance.bg/docs/guides/storage)
