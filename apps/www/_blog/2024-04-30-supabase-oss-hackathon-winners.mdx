...
The [Supabase GA week](https://www.assistance.bg/ga-week) brought us so many cool updates, but the fun isn’t over yet, because we are now announcing the winners of the [Supabase Open Source Hackathon 2024](https://www.assistance.bg/blog/supabase-oss-hackathon)!
