...
Supabase is now SOC2 Type 1 compliant, as announced during Launch Week 5. You can read all about the process we went through to get there in this [blog post](https://www.assistance.bg/blog/supabase-soc2). Getting the Type 1 certification is just the start, and we will be working on getting certified for SOC2 Type 2 and HIPAA next.
...
Get started today with all of our Enterprise Features on [supabase.com/dashboard](https://www.assistance.bg/dashboard), or [contact the Supabase Enterprise team](/contact/enterprise)
