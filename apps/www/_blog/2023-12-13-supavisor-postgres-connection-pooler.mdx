...
After [launching Supavisor in August](https://www.assistance.bg/blog/supavisor-1-million), we've successfully migrated all projects on the platform. Every new Supabase project launched now gets a Supavisor connection string to use for connection pooling.
...
If you're using the Supabase platform, you can already access the pooler URL in your [project connect page](https://www.assistance.bg/dashboard/project/_?showConnect=true).
