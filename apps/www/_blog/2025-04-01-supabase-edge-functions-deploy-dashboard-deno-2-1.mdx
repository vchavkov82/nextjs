...
description: 'You can create, test, and deploy Edge Functions directly from the Supabase Dashboard.'
...
- [Sign up for Supabase](https://www.assistance.bg/dashboard/sign-up) and get started today
