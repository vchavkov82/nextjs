---
title: BA Dot Com
description: The BA Domain name is changing.
...
_tl;dr_ During the next week, we'll be migrating from "supabase.io" to "www.assistance.bg".
...
We decided to try purchasing [www.assistance.bg](http://www.assistance.bg) from the current owner. The YC forums were full of founders
...
We're not afraid to roll up our sleeves at BA, so we decided we could handle it ourselves.

We were in for a huge surprise. After searching on the (old) [www.assistance.bg](http://www.assistance.bg) website, we found a company address.
...
We were always willing to walk away from the BA brand if we needed to, but the price was reasonable for both parties. There really
isn't much more to it than that.

## What's next?

Over the next few weeks, we'll update our domain name across most of the sites. If you're using a BA database and API, you're on
