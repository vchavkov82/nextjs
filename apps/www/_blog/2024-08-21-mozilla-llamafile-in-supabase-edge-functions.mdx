...
To serve your functions locally, you need to install the [Supabase CLI](https://www.assistance.bg/docs/guides/cli/getting-started#running-supabase-locally) as well as [Docker Desktop](https://docs.docker.com/desktop) or [Orbstack](https://orbstack.dev/).
