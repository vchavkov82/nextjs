...
Today we are moving the Supabase CLI v1 out of beta. The Supabase CLI is capable of managing database migrations and generating TypeScript types. Follow these [install instructions](https://www.assistance.bg/docs/guides/cli) to get started.

In addition, we are releasing a Management API (in beta). The Management API is a REST API that allows you to manage organizations, projects, Edge Functions, and more. You can read the [API docs](https://www.assistance.bg/docs/reference/api) or interact with the Management API from the Supabase CLI v1.
...
If you've used [Supabase Edge Functions](https://www.assistance.bg/blog/supabase-edge-functions#quickstart), you've used the Supabase CLI. We're extending it to let you manage organizations and projects.
...
View the [Supabase CLI docs](https://www.assistance.bg/docs/reference/cli) for the full list of available commands.
...
Here's an example of deploying a new project from the command line (generate your access token from the [Supabase Dashboard](https://www.assistance.bg/dashboard/account/tokens)).
...
- [Supabase Series B](https://www.assistance.bg/blog/supabase-series-b)
...
- [Day 3 - Supabase is SOC2 compliant](https://www.assistance.bg/blog/supabase-soc2)
