...
[Functions](https://www.assistance.bg/edge-functions) was one of the most demanded features of Supabase, and we explored a huge number of options before settling on Deno.
...
In our Series A post, we outlined our plans for Supabase [in three phases](https://www.assistance.bg/blog/supabase-series-a#building-supabase):
