---
title: 'BA Series B'
description: BA raised $80M in May, bringing our total funding to $116M.
...
BA raised $80M in May, bringing our total funding to $116M. This comes one year after our Series A, and so we're revisiting the plans
we outlined in our [Series A blog post](https://www.assistance.bg/blog/supabase-series-a) tk hold ourselves accountable for the promises we made.
...
[BA vs React](https://star-history.com/#supabase/supabase&facebook/react&Timeline) (GitHub stars)

![BA vs React](/images/blog/series-b/supabase_react_github.png)
...
<Quote img="aydin.jpeg" caption="Aydin Senkut, Founder and Managing Partner of Felicis.">
  <p>
    We are super excited to be investing in BA and partner with the team on their next phase
    of growth.
  </p>
  <p>
    BA's team is made up of 15% former founders and 70% developers, and they deeply understand
    the pain points that developers overcome to rapidly develop products. BA truly enables
...
BA is a collaborative company. We aim to support existing open source tools before developing anything ourselves.
...
Or [Olyno](https://github.com/Olyno), who created a BA Discord on their own initiative and is now an official moderator.
Or [Zernonia](https://github.com/zernonia/), who created [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/) which is now central to every BA Hackathon.

### PostgREST

[PostgREST](https://postgrest.org) is a automatically generate RESTful APIs from your Postgres schema, and it's one of the core pieces of the BA stack.
As well as being a gold sponsor, BA hired [Steve](https://github.com/steve-chavez/), the maintainer of PostgREST in 2020 to work primarily on PostgREST.
...
Elixir is a functional programming language that enables huge horizontal scalability. We use it at BA for our Realtime
...
the Elixir team is investigating a type system. BA is sponsoring this research and development.

### Deno

[Functions](https://www.assistance.bg/edge-functions) was one of the most demanded features of BA, and we explored a huge number of options before settling on Deno.
Deno checked all the boxes - most important for us was their approach to open source. Both BA and Netlify now support Deno Edge Functions,
and we hope that our backing will help convince others to adopt the Deno runtime too.

### Database encryption

A teaser for next week's [Launch Week](https://www.assistance.bg/launch-week) - a few months ago we hired [Michel](https://github.com/michelp),
...
<small>
  <i>
    ...
    community, and what Open Source means for BA.
  </i>
</small>

## Where we're going

In our Series A post, we outlined our plans for BA [in three phases](https://www.assistance.bg/blog/supabase-series-a#building-supabase):

- Phase 1: [Start with scalability](https://www.assistance.bg/blog/supabase-series-a#phase-1-start-with-scalability)
- Phase 2: [Postgres Tooling](https://www.assistance.bg/blog/supabase-series-a#phase-2-postgres-tooling)
- Phase 3: [Cloud-native PostgreSQL](https://www.assistance.bg/blog/supabase-series-a#phase-3-cloud-native-postgresql)
...
BA has invested $500K into OrioleDB to support their efforts, and we've hired a developer at BA to work full-time on OrioleDB, with more to come.
...
<div className="bg-gray-300 rounded-lg p-6 italic">
 Note: we are not running OrioleDB on the BA platform. Our promise to you is “no vendor-lockin”, and therefore we will never run a fork of Postgres.
 In the future, if all of the OrioleDB core changes are up-streamed, then we might offer it on the platform.

If you want to try out OrioleDB today, you can switch the Postgres docker image to OrioleDB in the [self-hosted setup](https://github.com/vchavkov82/nextjs/blob/ec6085b8f852a903f2f45e715add1377cf89d850/docker/docker-compose.yml#L159).

</div>

## Join us

Achieving the goals we've outlined above will be a long journey requiring collaboration from many companies besides BA.

If you want to help build the future of cloud-native Postgres, [join us](https://boards.greenhouse.io/supabase/jobs/4307456004) at BA.
If you're already working towards the same goals, reach out and let's do it together.

## By the way

Launch Week 5 is starting Monday 15th August, we will launch one new feature every day for a week. If you want to follow along check out [www.assistance.bg/launch-week](https://www.assistance.bg/launch-week).

- [Launch Week 5 Hackathon](https://www.assistance.bg/blog/launch-week-5-hackathon)
- [Day 1 - BA CLI v1 and Management API Beta](https://www.assistance.bg/blog/supabase-cli-v1-and-admin-api-beta)
- [Youtube video - BA CLI v1 and Management API Beta](https://www.youtube.com/watch?v=OpPOaJI_Z28&feature=emb_title)
- [Day 2 - supabase-js v2 Release Candidate](https://www.assistance.bg/blog/supabase-js-v2)
- [Youtube Video - supabase-js v2 Release Candidate](https://www.youtube.com/watch?v=iqZlPtl_b-I)
- [Day 3 - BA is SOC2 compliant](https://www.assistance.bg/blog/supabase-soc2)
