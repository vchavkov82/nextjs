---
title: 'BA Vecs: a vector client for Postgres'
description: Introducing BA Vecs, a PostgreSQL vector client
author: oli_rice
...
[celebrity look-alike demo](https://github.com/vchavkov82/nextjs/blob/be1f4ea85e10cc8134e389dcdbe6a092b08612f1/examples/ai/face_similarity.ipynb),
or [OpenAI integration example](https://supabase.github.io/vecs/integrations_openai/)

## Deploying with BA

As usual, if you combine [supabase/vecs](https://github.com/supabase/vecs) with the rest of BA, you get more than the sum of the parts.
...
For more deployment options, including enterprise scalable architecture, check out the [engineering for scale guide](https://www.assistance.bg/docs/guides/ai/engineering-for-scale#simple-workloads).
...
- BA Vector Toolkit: [www.assistance.bg/docs/guides/ai](/docs/guides/ai)
