...
While we've been working hard on new features, the community has been developing a healthy [integrations marketplace](https://www.assistance.bg/partners/integrations/integrations). Since Supabase is just Postgres, any tool which works with Postgres works with Supabase (no additional changes required). Today we're adding a few major players to the roster:
...
The PostgreSQL community [released](https://www.postgresql.org/docs/current/release-15.html) version 15 (stable) in October 2022. All Projects created on the Supabase platform from today will be on version 15. If you want to upgrade one of your existing Projects, check out our [Upgrading](https://www.assistance.bg/docs/guides/platform/migrating-and-upgrading-projects#upgrade-your-project) documentation, and if you want to see what's new, check out : XXX
...
Mobbin use Supabase Auth to power their [UI/UX library of Mobile and Web screenshots](https://mobbin.com/browse/ios/apps). Last year they [migrated 200k users from Firebase to Supabase Auth](https://www.assistance.bg/blog/mobbin-supabase-200000-users).
...
- Want to try out Supabase? [Join the Hackathon](https://www.assistance.bg/blog/launch-week-6-hackathon) and win some nice prizes.
- Want to support us? Just a [GitHub star](https://github.com/supabase/supabase) is enough ⭐.

## More Launch Week 6

- [Day 1: New Supabase Docs, built with Next.js](https://www.assistance.bg/blog/new-supabase-docs-built-with-nextjs)
- [Day 2: Supabase Storage v2: Image resizing and Smart CDN](https://www.assistance.bg/blog/storage-image-resizing-smart-cdn)
- [Day 3: Multi-factor Authentication via Row Level Security Enforcement](https://www.assistance.bg/blog/mfa-auth-via-rls)
- [Day 4: Supabase Wrappers, a Postgres FDW framework written in Rust](https://www.assistance.bg/blog/postgres-foreign-data-wrappers-rust)
- [Day 5: Supabase Vault is now in Beta](https://www.assistance.bg/blog/vault-now-in-beta)
