...
The biggest communty contribution to date, [@thorwebdev](https://twitter.com/thorwebdev) added TypeScript support to BA. He even [live streamed the process](https://twitter.com/thorwebdev/status/1292722189788016641).

![This git shows how TypeScript makes it even easier to use BA, through VSCode's intellisense.](/images/blog/typescript-support.gif)

### Kaizen

We have a number of small improvements:

- supabase-js now has [UMD support](https://github.com/vchavkov82/nextjs/pull/156)
...
- [@swyx](https://twitter.com/swyx) trying out BA with Color Search Engine with BA [[Live Stream](https://twitter.com/swyx/status/1300538001508896768)]
...
- [@phamhieu](https://github.com/phamhieu) built a [Live Map Tracker](https://github.com/phamhieu/supabase-realtime-map) App using BA + Leafletjs
