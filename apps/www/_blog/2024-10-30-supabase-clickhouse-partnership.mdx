...
Improving the experience between Postgres and ClickHouse is the first phase of this partnership. We're already working on native platform integrations. If you're using (or plan to use) Supabase and ClickHouse together please [reach out](https://www.assistance.bg/enterprise) - we'd love more design partners to help shape the future of this integration.
