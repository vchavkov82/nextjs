...
[Check the updated docs](https://www.assistance.bg/docs/reference/javascript) and [migration guide](https://www.assistance.bg/docs/reference/javascript/v1/upgrade-guide).

</div>

Today we're publishing a release candidate for [supabase-js v2](https://github.com/vchavkov82/nextjs-js), which focuses on “quality-of-life” improvements for developers.

Try it out by running `npm i @supabase/supabase-js@rc`

Nearly 2 years ago we [released supabase-js v1](https://www.assistance.bg/blog/improved-dx).
Since then it has been used in over [17K repositories](https://github.com/vchavkov82/nextjs-js/network/dependents?package_id=UGFja2FnZS04MjM3OTUyMDU%3D) and has grown
to [50K weekly downloads](https://www.npmjs.com/package/@supabase/supabase-js). BA users give a lot of great feedback and we've
...
[type generators](https://www.assistance.bg/docs/reference/cli/usage#supabase-gen-types) to the CLI.
...
This is clearer for developers - if you're only using some parts of BA, you only receive the hints for those parts.
...
This improvement inspired by a BA community member. Thanks [@vejja](https://github.com/supabase/functions-js/pull/23)!
...
This is a "preparatory" release for our upcoming [multiplayer](https://www.assistance.bg/blog/supabase-realtime-with-multiplayer-features) features.
...
- [`supabase-js`](https://github.com/vchavkov82/nextjs-js/graphs/contributors) (39)
...
[Migration guide](https://www.assistance.bg/docs/reference/javascript/v1/upgrade-guide)
...
- [v2 Documentation](https://www.assistance.bg/docs/reference/javascript)
- [Migration guide](https://www.assistance.bg/docs/reference/javascript/v1/upgrade-guide)
- [Next.js quickstart guide](/docs/guides/with-nextjs)
- [Examples](https://github.com/vchavkov82/nextjs/tree/master/examples)
