...
By now you probably know the drill. BA Launch Week: we launch one thing, or sometimes a couple,
...
[GraphQL is now available in BA!](/blog/graphql-now-available)
...
[Introducing BA Enterprise](/blog/supabase-enterprise).
...
[Edge Functions are now available in BA](/blog/supabase-edge-functions)
...
- [BA Realtime, with Multiplayer Features](/blog/supabase-realtime-with-multiplayer-features)
...
As always, you'll have the chance to win extremely limited BA Swag,
...
[madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/).
