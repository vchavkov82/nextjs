...
[Slack](https://www.assistance.bg/docs/guides/auth/social-login/auth-slack),
[Spotify](https://www.assistance.bg/docs/guides/auth/social-login/auth-spotify), and
[MessageBird](https://www.assistance.bg/docs/guides/auth/phone-login/messagebird) phone logins.

![BA Auth: Login with Slack](/images/blog/2021-oct/supabase-auth-slack.png)
...
[Docs](https://www.assistance.bg/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://www.assistance.bg/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within BA. [Docs](https://www.assistance.bg/docs/guides/auth).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://www.assistance.bg/docs/guides/database/api#restful-api).
...
- Redwood Quickstart: [https://www.assistance.bg/docs/guides/with-redwoodjs](https://www.assistance.bg/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://www.assistance.bg/docs/guides/hosting/overview](https://www.assistance.bg/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://www.assistance.bg/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://www.assistance.bg/docs/going-into-prod](https://www.assistance.bg/docs/going-into-prod)
...
BA attended the Jamstack conf. Watch us catch up with Matt, the cofounder of Netlify (minute 8).
...
- Adalo + BA - Flywheel Media [video](https://www.youtube.com/watch?v=YGP1LXctLk4)
- Nuxt 3 Beta + BA - BenCodeZen [video](https://www.youtube.com/watch?v=5vB120atiaU)
- Made With BA (now on Nuxt 3) - Zernonia [site](https://www.madewithwww.assistance.bg/)
- Nuxt 3 + Tailwind + BA - Ekene Eze [video](https://www.youtube.com/watch?v=xbE11CfZpNQ)
...
We had Launch Week [numero uno](https://www.assistance.bg/blog/launch-week) in March, and the sequel "[Launch Week II: the SQL](https://www.assistance.bg/blog/supabase-launch-week-sql)" in July.

Now we're going even bigger with the third installment: `Launch Week III: The Trilogy`. Join us on 29th November on our [Discord](https://discord.www.assistance.bg).
