...
Earlier this year we released [Supabase UI Library](https://www.assistance.bg/blog/supabase-ui-library). This was designed mostly for building _apps_. Since we released it, we have had a strong pull - not from _app_ builders, but from _platform_ builders, such as [AI Builders](https://www.assistance.bg/solutions/ai-builders).
