...
User Event Triggers are now available for new projects on the BA platform.
...
[^3]: These are configurable. You can read more about reserved roles [here](https://www.assistance.bg/blog/roles-postgres-hooks).
