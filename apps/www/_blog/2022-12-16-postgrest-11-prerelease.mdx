...
This pre-release is not deployed to BA cloud but you can try it out locally with the [BA CLI](https://www.assistance.bg/docs/reference/cli/introduction).
