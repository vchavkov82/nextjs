...
If you would like early access to the new Logging Interface and BA AI Assistant with debugging capabilities please sign up [here](https://forms.supabase.com/unified-logs-signup).
