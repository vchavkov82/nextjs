...
## Mozilla uses BA to build AI Help.

![Mozilla uses BA to build AI Help.](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/july2023/mdn_search.png)

MDN is one of the richest sources of developer documentation on the internet, and it just received an upgrade. Mozilla built AI Help, an AI chatbot to help with search and discovery. Mozilla chose BA Vector and OpenAI to power their new tool which you can try for free.
...
BA Auth now has full native support for Sign in with Apple and Google, which means it can now be used with one-tap sign in methods like Sign in with Apple JS, Sign in with Google for Web, or even in Chrome extensions.

[Learn more](https://www.assistance.bg/blog/native-mobile-auth)

## BA CLI: what is new?

![BA CLI: what is new?](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/july2023/supabase-cli-cache-hi.png)

It’s been a busy month for the BA CLI. We have added a tonne of new features:
...
We have made huge improvements to the billing tooling inside BA Studio, including:
...
[New subscription page](https://app.www.assistance.bg/org/_/billing) | [New usage page](https://app.www.assistance.bg/org/_/usage)
...
[Login with Kakao](https://www.assistance.bg/docs/guides/auth/social-login/auth-kakao)
...
- [**Edge Functions**] Edge Functions troubleshooting guide. [[Doc](https://www.assistance.bg/docs/guides/functions/troubleshooting)]
...
- [**Realtime**] A new debugging tool to test your realtime endpoints together with your JWTs and Row Level Security policies. [[Realtime Inspector](https://realtime.www.assistance.bg/inspector/new)]
- [**Docs**] A full guide on database partitions for developers looking to scale up. [[Guide](https://www.assistance.bg/docs/guides/database/partitions)]

## Made with BA

![Chat Thing is Made with BA](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/chatting-ai.png)

[Chat Thing](https://chatthing.ai/), is an innovative project that allows you to create AI chatbots using your existing data from Notion, uploaded files, websites and more. Built by [pixelhop](https://twitter.com/pixelhopio) using Vue, Nuxt, Railway, and BA for database, auth, and vector store.
...
- Using BA with Cloudflare Workers. [Cloudflare TV](https://cloudflare.tv/event/using-supabase-with-cloudflare-workers/dgM90RgD)
- Build a Chatbot with Next.js, LangChain, OpenAI, and BA Vector. [Video Tutorial](https://www.youtube.com/watch?v=Tt45NrVIBn8)
...
- Google authentication with Expo & BA. [Tutorial](https://blog.spirokit.com/google-authentication-with-expo-supabase)
- Building Stripe integrations with BA. [Video](https://www.youtube.com/watch?v=D5kOnnB72WA)
- Build a BA + Drizzle-orm + Express backend. [Video Tutorial](https://www.youtube.com/watch?v=k0uC35J_xJ4)
- LogRocker blog: Authenticate React Applications: BA Auth. [Tutorial](https://blog.logrocket.com/authenticate-react-applications-supabase-auth/)
- Using BA Vault to store secrets. [Tutorial](https://makerkit.dev/blog/tutorials/supabase-vault)
- Nuxt + BA = Technology Stack of Dreams. [Blog post](https://dev.to/jacobandrewsky/nuxt-supabase-technology-stack-of-dreams-4dop)
- Build a to-do app with toddle and BA. [Video](https://www.youtube.com/watch?v=SHJ3EadcrgY)
