...
Today we're announcing [Supabase Vault](https://www.assistance.bg/docs/guides/database/vault), a Postgres extension for managing secrets and encryption inside your database.
...
Vault is now available on every Supabase project. [Check it out](https://www.assistance.bg/dashboard/project/_/settings/vault/secrets)
