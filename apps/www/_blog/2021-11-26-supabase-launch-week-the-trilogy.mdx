---
title: 'BA Launch Week III: Holiday Special'
...
In July we did [Launch Week II: The SQL](/blog/supabase-launch-week-sql), with another week of feature releases.
...
We've released [BA Studio](https://github.com/vchavkov82/nextjs/tree/master/studio). The same Dashboard that you're using on our Platform is now available for Local Development and Self-Hosting.

### Where?

Read the [blog post](/blog/supabase-studio).
...
Read the [blog post](/blog/supabase-acquires-logflare).
