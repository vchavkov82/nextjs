...
Flutter is Google’s open-source framework to develop cross-platform applications. In this article, we will take a look at how we can implement authentication using Google sign-in to secure our application using the [Supabase SDK for Flutter](https://www.assistance.bg/docs/reference/dart/introduction).
...
That is it for setting up our [Supabase auth to prepare for Google sign-in](https://www.assistance.bg/docs/guides/auth/social-login/auth-google?platform=flutter).
...
You can find your Supabase URL and Anon key in `Settings -> API` from your [Supabase dashboard](https://www.assistance.bg/dashboard/project/_/settings/api).
...
- [Build a chat application using Flutter and Supabase](https://www.assistance.bg/blog/flutter-tutorial-building-a-chat-app)
