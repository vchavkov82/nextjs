...
With our new support for WebSockets, you can easily do this in Edge Functions without standing up any infrastructure. Additionally, you can use [Supabase Auth](https://www.assistance.bg/docs/guides/auth) to authenticate users and protect your OpenAI usage from being abused.
