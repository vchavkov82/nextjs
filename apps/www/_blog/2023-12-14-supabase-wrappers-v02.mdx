...
To start using Wrappers on the Supabase platform, check out the [Wrappers docs](https://www.assistance.bg/docs/guides/database/extensions/wrappers/overview).
...
- [Blog Post: Supabase Wrappers, a Postgres FDW framework written in Rust](https://www.assistance.bg/blog/postgres-foreign-data-wrappers-rust)
