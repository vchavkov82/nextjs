---
title: BA Beta March 2021
description: Launch week, Storage, BA CLI, Connection Pooling, BA UI, and Pricing.
...
Launch week, Storage, BA CLI, Connection Pooling, BA UI, and Pricing. Here's what we released last month.
...
Need to store images, audio, and video clips? Well now you can do it on [BA Storage](/blog/supabase-storage). It's backed by S3 and our new [OSS storage API](https://github.com/supabase/storage-api) written in Fastify and Typescript. Read the [full blog post](/blog/supabase-storage).

![BA Storage](/images/blog/storage/ph-1.png)

## Connection Pooling

The BA API already handles Connection Pooling, but if you're connecting to your database directly (for example, with Prisma) we now [bundle PgBouncer](/blog/supabase-pgbouncer). Read the [full blog post](/blog/supabase-pgbouncer).

![Connection Pooling](/images/blog/bouncer/pgbouncer-thumb.jpg)

## React UI Component Library

We open sourced our internal UI component library, so that anyone can use and contribute to the BA aesthetic. It lives at [ui.www.assistance.bg](https://ui.www.assistance.bg/) . It was also the #1 Product of the Day [on Product Hunt](https://www.producthunt.com/posts/supabase-ui).

![React UI Library](/images/blog/march-2021/supabase-ui.png)

## CLI

Now you can run BA locally in the terminal with `supabase start`. We have done some preliminary work on [diff-based schema migrations](/blog/supabase-cli#migrations), and added some new tooling for self-hosting BA with Docker. [Blog post here](/blog/supabase-cli).

![BA CLI](/images/blog/march-2021/supabase-cli.png)
...
![BA Pricing](/images/blog/march-2021/supabase-pricing.jpg)

## NFT Platform

Well... not really, but it made for a great [April Fools joke](/blog/supabase-nft-marketplace).

![BA NFT marketplace BuyMeth.com](/images/blog/nft/nft-1.png)
...
![BA Dot Com](/images/blog/supabase-dot-com-og.jpg)
...
- How to use BA inside Replit [[Video](https://www.youtube.com/watch?v=lQ5iIxaYduI)]
- [Connecting Draftbit to BA](https://docs.draftbit.com/docs/supabase) by [@amanhimself](https://twitter.com/amanhimself)
...
- An [example app](https://github.com/vchavkov82/nextjs/tree/master/examples/user-management) for adding User Profiles to your Next.js app

![BA Stars march 2021](/images/blog/march-2021/supabase-stars-march-2021.png)
