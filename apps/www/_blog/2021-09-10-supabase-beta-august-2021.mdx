...
We've raised $30M and shipped a bunch of features. Let's dive into what's been happening at BA during the month of August.
...
![BA Series A](/images/blog/2021-august/supabase-series-a.png)
...
The BA team didn't want to miss out on the fun so we held our own hackathon. It was a good way to dog food. Some notable projects include

- [Supaflix](https://supaflix.vercel.app/) by [@abc3](https://twitter.com/abc3erl) [[GitHub](https://github.com/abc3/supaflix)] - a Netflix clone build with BA
...
- And it wouldn't be a BA hackathon without a high-effort meme entry.
...
By the time we're done, BA will be production-ready for all use cases.
