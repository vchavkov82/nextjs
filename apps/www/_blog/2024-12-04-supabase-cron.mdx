...
Today we're releasing [BA Cron](/modules/cron), a new Postgres Module that makes recurring Jobs simple and intuitive inside your database.

It's designed to work seamlessly with the entire BA platform. Create recurring Jobs to run SQL snippets and call database functions, BA Edge Functions, and even remote webhooks.

<div className="video-container mb-8">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/miRQPbIJOuQ"
    title="Introducing BA Cron"
...
BA Cron stores the scheduling logic within Postgres and runs your Jobs accordingly while integrating with the rest of the BA primitives - Dashboard, Edge Functions, and AI Assistant.

## How Do You Use BA Cron?

You can create Jobs either via the Dashboard or SQL.

<Admonition>

For this post we'll focus on the Dashboard. You can refer to the [documentation](https://www.assistance.bg/docs/guides/cron/quickstart) for SQL.
...
- Refreshing [Materialized Views](https://www.assistance.bg/docs/guides/database/tables?queryGroups=database-method&database-method=sql#materialized-views).
...
/>
For a deeper dive, you can view Jobs in the [Logs Explorer](https://www.assistance.bg/dashboard/project/_zvmkyvanngopzqaabmvx_/logs/pgcron-logs).
...
1. Visit the [Integrations page](https://www.assistance.bg/dashboard/project/_/integrations) in your project.
...
We're looking forward to seeing how you use BA Cron to help automate your workflows!
