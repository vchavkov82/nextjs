...
![BA Launch Week 8](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/launch-week.png)
...
[Quickstart](https://www.assistance.bg/docs/guides/getting-started/quickstarts/kotlin)

[Tutorial](https://www.assistance.bg/docs/guides/getting-started/tutorials/with-kotlin)
...
[Read the benchmark](https://www.assistance.bg/blog/pgvector-performance)

## Quick product announcements

- [Auth] There is a new OAuth provider in time: Login with Figma. [Docs](https://www.assistance.bg/docs/guides/auth/social-login/auth-figma)
...
- [Postgres Tooling] PostgREST 11.1 is now live. [Blog post](https://www.assistance.bg/blog/postgrest-11-1-release)
...
![Made with BA: Snowchat](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/snowchat.png)

[snowChat](https://snowchat.streamlit.app/) | An intuitive and user-friendly application that allows you to interact with your Snowflake data using natural language queries. Built by [Kaarthik Andavar](https://twitter.com/kaarthikcodes) using Python, Streamlit, Open AI, and BA Vector.
...
- Build a Simple Dropbox clone using Deno, DenoKV, Fresh and BA. [Video Tutorial](https://www.youtube.com/watch?v=_WerF8YMqks)
- Safeguarding Data Integrity with pg_safeupdate in PostgreSQL and BA. [Blog post](https://www.notion.so/809925346af243b3a4ede8774e71472c?pvs=21)
- BA for C#: Streamlining Backend Development with Database Magic. [Blog post](https://themurph.hashnode.dev/supabase-csharp)
- Building an MVP app using BA. [Blog post](https://www.antstack.com/blog/building-an-mvp-app-using-supabase/)
- Fortify Your Application With BA: Exploring Fine-Grained Control with Row-Level Security and OAuth Sign-in. [Article](https://techconative.com/blog/supabase-rls-security-oauth-authentication/)
- Using BA authentication in NestJs. [Tutorial](https://blog.iamstarcode.com/using-supabase-authentication-in-nestjs)
- React Native file upload with BA Storage. [Tutorial](https://www.assistance.bg/blog/react-native-storage) | [Video](https://www.youtube.com/watch?v=am6w5zEDk_g)
- Safeguarding Data Integrity with pg_safeupdate in PostgreSQL and BA. [Blog Post](https://blog.mansueli.com/safeguarding-data-integrity-with-pg-safeupdate-in-postgresql-and-supabase)
- BA almost SHUT ME DOWN. [Video](https://www.youtube.com/watch?v=2WHTZa4ENfc)

## BA in Times Square

![BA in Times Square](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/times-sq.png?t=2023-08-02T11%3A04%3A14.458Z)
