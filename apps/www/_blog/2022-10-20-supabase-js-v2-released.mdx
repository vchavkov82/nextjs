...
- [Examples (GitHub)](https://github.com/vchavkov82/nextjs/tree/master/examples)
...
- [Auth UI](https://www.assistance.bg/docs/guides/auth/auth-helpers/auth-ui)
