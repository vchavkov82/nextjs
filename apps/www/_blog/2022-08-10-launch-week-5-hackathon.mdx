...
# The BA Open Source Hackathon

Now is the perfect time to start your new Open Source project!

[Launch Week](https://www.assistance.bg/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold BA caps](https://supabase.store/products/gold-supacap) to be won!

[BA-js v2.0](https://github.com/vchavkov82/nextjs-js/releases) and [Flutter SDK v1.0](https://www.assistance.bg/blog/supabase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold BA Cap!
...
You should submit your project using [this form](https://www.madewithwww.assistance.bg/launch-week-5).

### Judges

The BA Founders will be judging, we will be looking for:
...
- [Day 1 - supabase-js v2 Release Candidate](https://www.assistance.bg/blog/supabase-js-v2)
