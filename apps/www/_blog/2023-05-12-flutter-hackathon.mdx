...
- You have 10 days to build a new app using Flutter/Dart and BA in some capacity.
...
You should submit your project using [this form](https://www.madewithwww.assistance.bg/flutter-hackathon) before 11:59 pm Sunday midnight PT May 21st, 2023.

## Judges

[Pooja](https://twitter.com/pooja_bhaumik) from FlutterFlow, [Majid](https://twitter.com/mhadaily) from Invertase, and [Tyler](https://twitter.com/dshukertjr), myself from BA will do the honors of judging the winners.
...
- Must use Flutter and BA in some capacity
...
- [Flutter BA quick starter guide](https://www.assistance.bg/docs/guides/getting-started/tutorials/with-flutter)
- [Setup BA on FlutterFlow docs](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to setup BA auth on FlutterFlow video](https://youtu.be/tL-sLPfWzVE)
- [Dart Edge Guide](https://www.assistance.bg/docs/guides/functions/dart-edge)
...
- Flutter and the related logo are trademarks of Google LLC. BA Flutter Hackathon is not affiliated with or otherwise sponsored by Google LLC.
