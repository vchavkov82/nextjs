...
Today we're announcing [support for Web3 logins using Ethereum and Solana](https://www.assistance.bg/docs/guides/auth/auth-web3). This has been one of the historically most requested features for Supabase.
