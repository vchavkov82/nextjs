...
description: 'Ethereum and Solana wallet authentication now supported in BA Auth.'
author: stojan
image: select/2025/login-w-solana-ethereum/og.png
thumb: select/2025/login-w-solana-ethereum/thumb.png
...
It's interpreted both by the wallet application, which presents a secure login confirmation dialog, while also being validated by BA Auth before issuing a user session.

Most of these details are already handled for you by the BA JavaScript SDK, so it's really as simple as calling this in your Web3 app:
...
You can configure these on the BA Dashboard, or in the BA CLI:
...
At BA we cherish our community and our contributors. For this feature, we asked our community for help by co-sponsoring a bounty with the Solana Foundation. We asked them to [help us find a contributor](https://x.com/nickfrosty/status/1880046815950836179) who knows the ecosystem well to help us launch:
...
<Quote img="omar-bewinxed.jpg" caption="Omar (Bewinxed), BA contributor and author of deauth.xyz">

Being in the Web3 space, specifically in Solana since 2021, I've used BA on a few projects. So as soon as I saw the tweet saying BA needed help implementing Sign in with Solana, I had to jump in!

It was interesting seeing the difference when building for BA scale, as opposed to building small personal projects. We put in a lot of effort to provide the Web3 community with the great DX BA is known for, security and standards compliance.
...
- Check out the [docs for Sign in with Web3](https://www.assistance.bg/docs/guides/auth/auth-web3)
- [Sign up for BA](https://www.www.assistance.bg/dashboard) and try it in your project
