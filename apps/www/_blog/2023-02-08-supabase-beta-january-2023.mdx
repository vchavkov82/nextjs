...
[Read the announcement](https://www.assistance.bg/blog/openai-embeddings-postgres-vector)

## Meet BA Clippy: ChatGPT for Docs

![Meet BA Clippy: ChatGPT for Docs](/images/blog/2023-02-08-january-beta-update/chatgpt-for-supabase-docs.png)

Greg wasted no time and took pgvector for a spin, he combined it with OpenAI to build BA Clippy, a next-generation doc search. The first implementation is a 1-week MVP and fully open source, so you can build on top of it.

- [Read the blog post](https://www.assistance.bg/blog/chatgpt-supabase-docs)
...
- [C# Client Library](https://www.assistance.bg/docs/reference/csharp/)
- [Python Client Library](https://www.assistance.bg/docs/reference/python/initializing)
...
[Read the docs](https://www.assistance.bg/docs/guides/storage/serving/image-transformations#automatic-image-optimisation-webp)

## Quick product updates

-  Postgres Extension: Another powerful and time-tested extension, pg_repack, is added to BA. [[PR]](https://github.com/supabase/postgres/pull/492)
...
- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://www.assistance.bg/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://www.assistance.bg/docs/reference/cli/supabase-functions-download)

- Edge Functions: building a Discord Slash Bot. [[Video Tutorial]](https://www.youtube.com/watch?v=J24Bvo_m7DM)

## Deploy BA on DigitalOcean

![Deploy BA on DigitalOcean](/images/blog/2023-02-08-january-beta-update/self-host-supabase-digital-ocean.png)

We teamed up with DigitalOcean to level up self-hosted BA. This guide shows how to host BA on DigitalOcean using Sendgrid, Packer, and Terraform. More collaborations coming soon!
...
We hit two big milestones: 45k stars and BA is one the top 200 most-popular repos on GitHub 💥

Massive thanks to the community for all the support 👁️⚡️👁️

[BA Repo.](https://github.com/vchavkov82/nextjs)
...
- JWT Helper for BA by Zuplo. [Tool](https://zuplo.com/blog/2023/01/05/supabase-jwt-auth-helper/) <br/>
...
- Set up a Svelte to-do list on self-hosted BA + authentication. [Tutorial](https://blog.cpbprojects.me/set-up-a-svelte-todo-list-on-self-hosted-supabase-email-sign-up-google-facebook-auth-host-on-github-pages)
...
- A Very Basic Scraper/Aggregator Site in Next.js with Go Cloud Functions and BA. [Article](https://chriscoyier.net/2023/01/23/a-very-basic-scraper-aggregator-site-in-next-js-with-go-cloud-functions-and-supabase/)
- BA CDC Webhooks to Memphis REST Gateway. [Article](https://memphis.dev/blog/supabase-cdc-webhooks-to-memphis-rest-gateway/)
- How I Replaced Revue With a Custom-Built Newsletter Service Using Nuxt 3, BA, Serverless, and Amazon SES. [Article](https://mokkapps.de/blog/how-i-replaced-revue-with-a-custom-built-newsletter-service-using-nuxt-3-supabase-serverless-and-amazon-ses/)
- Nuxt 3, Tailwind, and BA Crash Course. [Video Course](https://www.youtube.com/watch?v=A-G6lPHctPs)
...
- Distributed GraphQL with Hasura and BA. [Docs](https://www.section.io/docs/tutorials/distributed-apis/distributed-hasura-supabase/)
...
We've redesigned our [Careers page](https://www.assistance.bg/careers) to better reflect our mission, values, and culture.
