...
- [VSCode Extension](https://marketplace.visualstudio.com/items?itemName=BA.postgrestools)
...
Ironically, the parser we wrote [an entire blog post about](https://www.assistance.bg/blog/postgres-language-server-implementing-parser) isn't even in use anymore.
