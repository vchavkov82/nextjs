...
[@samuelP09301972](https://twitter.com/samuelP09301972), the creator of Syno will receive a limited Flutter-themed BA keyboard.
...
If you missed the hackathon, but still want to build awesome apps using Flutter and BA, here are some resources to get you started:

- [Flutter Quick Start Guide](https://www.assistance.bg/docs/guides/with-flutter)
- [BA Flutter documentation](https://www.assistance.bg/docs/reference/dart/introduction)
- [Edge Functions Guide](https://www.assistance.bg/docs/guides/functions)
- [Setup BA on FlutterFlow guide](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to Set Up BA Authentication in FlutterFlow video](https://www.youtube.com/watch?v=tL-sLPfWzVE)
