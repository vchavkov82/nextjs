...
Once the function is ready, you can [run it locally](https://www.assistance.bg/docs/guides/functions/quickstart) or [deploy it to a remote Supabase instance](https://www.assistance.bg/docs/guides/functions/deploy).
