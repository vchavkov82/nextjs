...
During [Launch Week 5](https://www.assistance.bg/launch-week), we shipped a lot of features, which was exciting, but what is more exciting is reviewing all the awesome hackathon submissions you all created for [Launch Week 5 Hackathon!](https://www.assistance.bg/blog/launch-week-5-hackathon)

It is always tough to pick the winner, but this time around it was extra hard because of the amount of incredible projects: there were 46 submitted projects, making this our most popular hackathon yet. You will be able to view all of the submissions of this hackathon on [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/).

And now, without further ado, congratulations to the winners of BA Launch Week 5 Hackathon!

## Best Overall Project

### Winner

[BA Cache Helpers](https://github.com/psteinroe/supabase-cache-helpers) - by [@psteinroe](https://twitter.com/psteinroe).

BA Cache Helpers is a caching utility library that works by turning your BA query into cache keys and provides methods for retrieving and mutating data on your BA database.

![BA Cache Helpers](/images/blog/lw5-hackathon-winners/supabase-cache-helpers.png)
...
Stripe Sync allows you to automatically sync your stripe data into your BA database using Edge Functions.
...
With RepoWatch, you can view any updates on across all the repositories in the BA GitHub org in realtime.
...
As promised in the [hackathon announcement article](https://www.assistance.bg/blog/launch-week-5-hackathon), each members of the winners will receive a limited edition golden BA cap!

![Golden BA Cap](/images/blog/lw5-hackathon/cap.png)
...
And if you want to be part of the community and build with us, find other people using BA, or if you just want to chill and watch people build, come and join us in Discord!

![Join BA Discord Channel](/images/blog/hackathon/community.png)
...
- [**supabase-js v2 Release Candidate**](https://www.assistance.bg/blog/supabase-js-v2)
- [**BA Realtime Guide**](https://www.assistance.bg/docs/guides/realtime)
- [**Flutter Quick Start Guide**](https://www.assistance.bg/docs/guides/with-flutter)
