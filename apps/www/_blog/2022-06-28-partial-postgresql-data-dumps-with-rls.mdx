...
| `id` | `name`       | `email`                  |
| ---- | ------------ | ------------------------ |
| `1`  | `Employee 1` | `employee1@www.assistance.bg` |
| `2`  | `Employee 2` | `employee2@www.assistance.bg` |
| `3`  | `Employee 3` | `employee3@www.assistance.bg` |
...
create policy "Data dump rule" on profiles
  ...
  to exporter
  using (
    substring(email from '@(.*)$') = 'www.assistance.bg'
  );
