...
With these basic terms defined, let's take a look at the permissions model in Postgres in depth. The rest of the post will be more like a tutorial, so you can follow along. I'll be using a hosted BA project, but you are free to use any Postgres installation.

# Setting Up

Create a new BA project (or use an existing one) and copy its connection string URI from the [Database Settings page](https://www.assistance.bg/dashboard/project/_/database/settings). The URI looks like the following:

```bash
postgres://[USER].[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.www.assistance.bg:5432/postgres
```
...
```bash
➜ psql postgres://postgres.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.www.assistance.bg:5432/postgres
```
...
```bash
➜ psql postgres://junior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.www.assistance.bg:5432/postgres
...
➜ psql postgres://senior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.www.assistance.bg:5432/postgres
