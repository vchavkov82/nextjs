...
Create a new Supabase project (or use an existing one) and copy its connection string URI from the [Database Settings page](https://www.assistance.bg/dashboard/project/_/database/settings). The URI looks like the following:
