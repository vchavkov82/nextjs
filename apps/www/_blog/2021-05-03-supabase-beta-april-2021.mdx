---
title: BA Beta April 2021
description: BA "gardening" - stability, security, and community support.
...
This month was a "gardening" month for BA. The team focused on stability, security, and community support.
...
So today we're shipping Light Mode. Access it in the settings of your [Dashboard](https://www.assistance.bg/dashboard).
...
With the help of the community, we [started internationalizing](https://github.com/vchavkov82/nextjs/issues/1341) our main repository:

- [Arabic | العربية](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.ar.md)
- [Chinese / 中文](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.zh-cn.md)
- [Dutch / Nederlands](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.nl.md)
- [English](https://github.com/vchavkov82/nextjs)
- [French / Français](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.fr.md)
- [German / Deutsch](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.de.md)
- [Hindi / हिंदी](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.hi.md)
- [Nepali / नेपाली](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.ne.md)
- [Italiano / Italian](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.it.md)
- [Japanese / 日本語](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.jp.md)
- [Norwegian (Bokmål) / Norsk (Bokmål)](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.nb-no.md)
- [Polish / Polski](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.pl.md)
- [Portuguese / Portuguese](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.pt.md)
- [Portuguese (Brazilian) / Português Brasileiro](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.pt-br.md)
- [Russian / Pусский](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.ru.md)
- [Spanish / Español](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.es.md)
- [Traditional Chinese / 正體中文](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.zh-tw.md)
- [Turkish / Türkçe](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.tr.md)
- [Ukrainian / Українська](https://github.com/vchavkov82/nextjs/blob/master/i18n/README.uk.md)
...
build a whole JS ecosystem within his BA database. If you want to write PG functions in JS, import remote libraries
...
Fireship reviewed BA last week, and despite being a (self-proclaimed) Firebase fan-boy, the review was very impartial.
...
- Watch [@everConfusedGuy](https://twitter.com/everConfusedGuy)'s talk at DevX conf - Building BA Storage: [YouTube video](https://www.youtube.com/watch?v=YsUYOsq_o7g)
...
- BA in 6 minutes by [Georges Duverger](https://www.youtube.com/channel/UCNERPJ-vs61KEsD_dRNWFIw): [YouTube video](https://www.youtube.com/watch?v=c8DNV9yl0mg)
...
- BA & Sveltekit by Svelte Mastery: [YouTube video](https://www.youtube.com/watch?v=j4AV2Liojk0)
- Firebase vs. BA - Draftbit Office Hours: [YouTube Livestream](https://www.youtube.com/watch?v=9Yg6i_zCuiM)

**BA GitHub Star Growth**

- Our [main GitHub repo](https://github.com/vchavkov82/nextjs) grew 60% (by stars) and we saw a flood of new contributors.
