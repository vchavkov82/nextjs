...
description: 'Bring lightning-fast search to your BA apps, with no code required.'
categories:
  - launch-week
tags:
  - launch-week
...
Today, Algolia is launching a new BA Connector, making it easier than ever to index your Postgres data and power world-class search experiences without writing a single line of code.

<div className="video-container mb-8">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/sLr6-K7_Av8"
    title="How to Integrate Algolia with Your BA Project"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; fullscreen; gyroscope; picture-in-picture; web-share"
    allowfullscreen
  />
</div>

With just a few clicks, you can connect your BA database to Algolia, select the tables you want to sync, and configure how often the data updates. Algolia handles the rest. You get a fast, reliable, scalable search index, and your team gets to focus on building.

## Partners Integrating with BA

BA is more than a backend. It is a growing ecosystem of tools that work well together so developers can build faster, scale more easily, and stay focused on their product.

Partners like Algolia bring best-in-class functionality (in Algolia’s case, fast and flexible search) directly into the BA workflow. For developers, that means fewer workarounds, no glue code, and a smoother path from idea to production.

For partners, integrating with BA means more than technical compatibility. It means product visibility to tens of thousands of active projects. BA regularly features integrations in our docs, Launch Weeks, blog, and community programs. Developers discover and adopt your product in the context where they’re already building.

Read on to see how the Algolia Connector for BA works.

## How to use Algolia Connector for BA

To get started with Algolia’s connector, prepare the data in your BA database, create BA as a source in Algolia’s dashboard, set up your Algolia index and configure your sync job. Here’s how you can [get started](https://www.algolia.com/doc/guides/sending-and-managing-data/send-and-update-your-data/connectors/supabase?utm_medium=referral&utm_source=supabase&utm_campaign=supabase_blog) in just a few minutes.

### 1. Prepare your data in BA
...
2. Find "BA" in the list and click [Connect](https://dashboard.algolia.com/connectors/supabase/create?utm_medium=referral&utm_source=supabase&utm_campaign=supabase_blog)

### 3. Configure your data source

First, you will need to fill in your BA connection info. From the BA dashboard:
...
4. Enter your BA database **password**
...
Once you create BA as a data source, you'll need to tell Algolia where to index your data.
...
Once configured, create the task. Algolia will start syncing records from BA into your search index (in the YouTube demo above, 8,800+ movie records were synced in under a minute).

You can now instantly search your BA data using Algolia's lightning-fast API.

## No more data pipelines. Just fast search.

With the Algolia + BA connector, you don’t need to build or maintain custom data pipelines. With Algolia, you don’t need to worry about scaling your own search infrastructure. With Algolia’s API clients, you just connect and go.
