...
Offline sync is one of the most requested features for Supabase. I caught up with the team at ElectricSQL to learn more about their [integration](https://www.assistance.bg/partners/integrations/electricsql).
