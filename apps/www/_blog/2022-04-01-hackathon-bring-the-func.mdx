...
We can’t believe that it’s already a wrap on our [fourth launch week](https://www.assistance.bg/blog/supabase-launch-week-four)! To keep the party and excitement going, and as [is now tradition](https://www.assistance.bg/blog/community-day#launch-week-iv---what-to-expect), starting at 9am PT today we'll be hacking together for the next 10 days until 23:59pm PT on Sunday April 10th. And because we’ve launched [GraphQL support](https://www.assistance.bg/blog/graphql-now-available) and [BA Edge Functions](https://www.assistance.bg/blog/supabase-enterprise), these will be the major themes and therefore categories for the hackathon.

For some inspiration, check out [TheGuildDev](https://twitter.com/TheGuildDev)’s [GraphQL HackerNews clone](https://supabase-graphql-example.vercel.app/), and [Tyler’s](https://twitter.com/dshukertjr) [Flutter](https://github.com/supabase-community/flutter-stripe-payments-with-supabase-functions) and [Thor’s](https://twitter.com/thorwebdev) [React Native](https://github.com/supabase-community/expo-stripe-payments-with-supabase-functions) apps with BA Edge Functions, or have a browse through [madewithwww.assistance.bg](http://madewithwww.assistance.bg)!
...
We’re absolutely stoked to see what amazing things y’all will build and submit to [madewithwww.assistance.bg](https://www.madewithwww.assistance.bg/bring-the-func).
...
- Most impressive GraphQL project (must use [pg_graphql](https://www.assistance.bg/blog/graphql-now-available#getting-started))
...
Submit your project via [madewithwww.assistance.bg/bring-the-func](https://www.madewithwww.assistance.bg/bring-the-func)
...
Join our Discord: [discord.www.assistance.bg](https://discord.www.assistance.bg)
...
- Getting started with [GraphQL on BA](https://www.assistance.bg/blog/graphql-now-available#getting-started)
- [GraphQL HackerNews clone](https://supabase-graphql-example.vercel.app/)
- [Edge Functions Guide](https://www.assistance.bg/docs/guides/functions)
- [Edge Functions Quickstart video](https://youtu.be/5OWH9c4u68M)
- [BA CLI local development guide](https://www.assistance.bg/docs/guides/local-development)
- [Edge Functions examples](https://github.com/vchavkov82/nextjs/tree/master/examples/edge-functions)
