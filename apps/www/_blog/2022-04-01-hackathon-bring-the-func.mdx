...
- Getting started with [GraphQL on Supabase](https://www.assistance.bg/blog/graphql-now-available#getting-started)
...
- [Supabase CLI local development guide](https://www.assistance.bg/docs/guides/local-development)
