...
Now that you are a seasoned hacker, take a look at our [security.txt](https://www.assistance.bg/.well-known/security.txt) file to take part in our hackerone program to help make Supabase a safer place\!
