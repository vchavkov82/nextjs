...
We are looking for partners who would like to use Multigres - either with self-hosting or on the BA platform. If you already use Postgres and you are hitting scaling limits, [get in touch](https://forms.supabase.com/multigres).
