...
BA Cron is a new Postgres module for creating and managing recurring tasks. It is deeply integrated with the rest of the BA toolset.

[Read more →](/blog/supabase-cron)

## #2: BA AI Assistant v2
...
"postgres.new" is now ["database.build"](https://database.build) and you can still run everything in your own browser. We've added 3 major features: Bring-your-own-LLM, Live Share, and they ability to deploy your [pglite](https://pglite.dev/) to BA.
...
Want to test hacking skills? We're running a Capture the Flag event called [Hack the Base](https://ctf.www.assistance.bg/). It's a free event that anyone can participate in.

[Read more →](/blog/hack-the-base)

### Launch Week 13: Hackathon

We're running a virtual hackathon starting **now** where you can win prizes for building the best projects using BA. We'll be announcing the winners on December 15th.
