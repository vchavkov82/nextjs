---
title: 'Announcing BA on JSR'
description: 'BA is now available on the open source JavaScript Registry (JSR).'
...
You can get started with BA using the `deno add` command:
...
console.log('BA Instance: ', supabase)
```
...
With the BA client on JSR, you can easily and quickly add authentication or persistent storage to your projects, which can run in any JavaScript environment!
