...
description: An evolution of how we approach AI within the BA dashboard
...
Today we are releasing BA Assistant v2 in the Dashboard - a global assistant with several new abilities:
...
<div className="video-container">
  <iframe
    ...
    title="We have improved BA AI ... A lot!"
...
## New abilities in BA Assistant v2
...
BA Assistant v2 is available today.
