...
Supabase Vault is now available on every Supabase project. [Check it out](https://www.assistance.bg/dashboard/project/_/settings/vault/secrets)
...
To learn how to use Supabase Vault, check out the [docs](https://www.assistance.bg/docs/guides/database/vault). Supabase Vault is now available on all [Supabase projects](https://www.assistance.bg/dashboard/project/_/settings/vault/secrets) (some projects will have to enable via request).
