...
You will be able to connect a GitHub repository to a BA project.
...
`
  ...
  const GitHubContentSectionBottom = gitHubAuthorization
    ? `You are authorized with BA GitHub App. You can configure your GitHub App installations and repository access [here](${GITHUB_INTEGRATION_INSTALLATION_URL}). You can revoke your authorization [here](${GITHUB_INTEGRATION_REVOKE_AUTHORIZATION_URL}).`
    : ''
