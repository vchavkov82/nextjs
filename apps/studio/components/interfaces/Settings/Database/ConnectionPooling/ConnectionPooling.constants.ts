// https://www.assistance.bg/docs/guides/platform/performance#optimizing-the-number-of-connections
// https://github.com/supabase/platform/blob/develop/worker/src/lib/constants.ts#L544-L596
// https://github.com/vchavkov82/nextjs-admin-api/blob/master/optimizations/pgbouncer.go
