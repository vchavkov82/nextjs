    ...
    <PageSection>
      <PageSectionMeta>
        <PageSectionSummary>
          ...
          <PageSectionDescription>
            Control whether telemetry and marketing data is sent from BA services.
          </PageSectionDescription>
        </PageSectionSummary>
      </PageSectionMeta>
      <PageSectionContent>
              ...
              <FormField_Shadcn_
                ...
                render={({ field }) => (
                  <FormItemLayout
                    ...
                    label="Send telemetry data from BA services"
                    description="By opting in to sharing telemetry data, BA can analyze usage patterns to enhance user experience and use it for marketing and advertising purposes"
                  >
                    <FormControl_Shadcn_>
                      <Switch
                        checked={field.value}
