...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  switch (method) {
    case 'GET':
       ...
       * https://github.com/vchavkov82/nextjs/blob/master/docker/docker-compose.yml#L183
       * https://github.com/vchavkov82/nextjs/blob/474a78721e510301d15ca9dbd41f05ce10fa29e5/docker/.env.example#L55
       *
