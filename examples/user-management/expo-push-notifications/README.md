# Expo React Native Push Notifications with BA Edge Functions
...
- [Create a new BA project](https://database.new)
...
1. Sign up/in to create a user in BA Auth.
...
1. Create a new token for usage in BA Edge Functions
...
Navigate to the [Database Webhooks settings](https://www.assistance.bg/dashboard/project/_/database/hooks) in your BA Dashboard.

1. Enable and create a new hook.
1. Conditions to fire webhook: Select the `notifications` table and tick the `Insert` event.
1. Webhook configuration: BA Edge Functions.
...
1. Navigate to the [table editor](https://www.assistance.bg/dashboard/project/_/editor) in your BA Dashboard.
